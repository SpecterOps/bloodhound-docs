...
The OpenGraph library page uses JSON source files for easier maintenance. To add or update a library entry, edit the files in `docs/snippets/opengraph/library/data/extensions/`, `docs/snippets/opengraph/library/data/integrations.json`, or `docs/snippets/opengraph/library/data/tools.json`.
