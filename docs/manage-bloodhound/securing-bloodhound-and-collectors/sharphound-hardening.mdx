...
Follow the article: [Create a gMSA for SharpHound](/collect-data/sharphound/install/configure-gmsa).
...
Follow the article: [Tiered SharpHound Strategy](/collect-data/sharphound/install/tiered-collector-strategy).
