...
- [Configure a webhook](/manage-bloodhound/alerts/configure) to configure an alert channel and rule.
- [Review the webhook contract](/integrations/webhooks/alert-webhook-contract) before you connect a receiver.
