---
title: Troubleshoot
description: Diagnose alert webhook configuration, delivery, and signature validation failures.
---
...
Use **Event History** and your alert webhook receiver logs to diagnose delivery failures. Do not share the HMAC secret while troubleshooting.
