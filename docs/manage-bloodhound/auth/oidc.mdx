...
3.  Create the OIDC Configuration in BloodHound.
  ...
  **Important:** OIDC users must have an email address that is **unique** across all authentication methods (built-in, OIDC, SAML). Account creation fails if a duplicate email is detected.  
    <Frame>
