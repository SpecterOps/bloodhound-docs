...
Users are created through **Settings <Icon icon="gear"iconType="solid" color="#22c55e"/>** <Icon icon="arrow-right"iconType="solid" color="#22c55e"/> **Administration <Icon icon="arrow-right"iconType="solid" color="#22c55e"/>** **Manage Users**, and clicking the button **Create User**.
