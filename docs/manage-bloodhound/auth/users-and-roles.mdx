...
| Configure API key expiration \[BHE\] | <Icon icon="square-check" iconType="solid" color="#22c55e"/> | -   | -   | -   | -   | -   |
...
For API key expiration behavior and configuration steps, see [Configure API key expiration](/manage-bloodhound/auth/api-key-expiration).
