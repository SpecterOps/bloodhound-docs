...
<Steps>
  ...
  <Step title="Regenerate an API token">
    ...
    1. Update the dependent [AzureHound](/install-data-collector/install-azurehound/create-configuration) or [SharpHound](/install-data-collector/install-sharphound/local-configuration#auth-json) configuration with the new API token and token ID.
  </Step>
</Steps>
