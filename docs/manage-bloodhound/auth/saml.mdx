...
<Frame>
  ...
  Enabling this option will have BloodHound create a new user on the first login with SSO (Just-In-Time). The user will be granted the role slug passed in the role claim if included, else the default role will be assigned.
