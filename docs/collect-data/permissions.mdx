...
* _Local Groups/NTLM_, collecting:
    ...
    * [NTLM](/collect-data/permissions#ntlm)
...
* _DC Registry/LDAP Services_, collecting:
    * [DC Registry](/collect-data/permissions#dc-registry)
    * [LDAP Services](/collect-data/permissions#ldap-services)
...
**Default Permissions:** Collecting these settings does not require any permissions.
