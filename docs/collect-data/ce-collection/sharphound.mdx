...
* From the [SharpHound repository releases](https://github.com/SpecterOps/SharpHound/releases) as .ps1 and a pre-compiled binary
* Build it from source with the source code on the [SharpHound repository](https://github.com/SpecterOps/SharpHound)
