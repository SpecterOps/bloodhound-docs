...
* From the [AzureHound repository releases](https://github.com/SpecterOps/AzureHound/releases) as .ps1 and a pre-compiled binary
* Build it from source with the source code on the [AzureHound repository](https://github.com/SpecterOps/AzureHound)
