...
To receive an external notification when a collector stops checking in, configure a [Collector Offline webhook alert](/manage-bloodhound/alerts/configure-webhooks).
