...
Data collection clients log completed jobs to the **Finished Jobs Log**, which provides details about all collection activities that a client performs. This log is essential for monitoring and troubleshooting data collection operations.

The **Finished Jobs Log** page provides a detailed log of each collection operation, including:

| Field | Value |
| --- | --- |
| **ID** | A unique identifier for the client collection operation |
...
To view the **Finished Jobs Log**:

<Steps>
  <Step title="Open the Finished Jobs Log page">
