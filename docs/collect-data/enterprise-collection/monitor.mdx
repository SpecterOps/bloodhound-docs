...
If you enable [Variable Analysis Mode](/analyze-data/findings/analysis#variable-analysis-mode), analysis triggered by Privilege Zone changes still appears as **Analyzing** in tenant status.
...
| **Data Collected** | The type of data that the client is configured to collect, see [SharpHound Data and Permissions](/collect-data/sharphound-data-permissions) and [AzureHound Data and Permissions](/collect-data/azurehound-data-permissions) |
