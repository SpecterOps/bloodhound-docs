...
<Steps>
  ...
  <Step title="Review upload details">
    After the upload completes, you can verify the status in the **Details** panel.

    Click the file ingest **ID** in the table to open the **Details** panel on the right side of the screen.
    ...
    It shows the file name and ingestion status of each file, which can be helpful for viewing data upload history or troubleshooting data upload issues.
      ...
      You can also click the <Icon icon="filter" /> icon to filter by status, data range, and user.
  </Step>
</Steps>
