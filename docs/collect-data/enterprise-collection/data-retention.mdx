...
<Note>
Manual HasSession edge deletion is generally only necessary in BloodHound Community environments. BloodHound Enterprise automatically reconciles session data through its built-in session reconciliation capability.
</Note>
