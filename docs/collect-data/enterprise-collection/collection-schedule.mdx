...
<Steps>
  ...
  <Step title="Create a data collection schedule">
    ...
    1. Configure the following details in the **Schedule** window:
        ...
        - **Data**: The type of data that the schedule collects, see [SharpHound Data and Permissions](/collect-data/sharphound-data-permissions) and [AzureHound Data and Permissions](/collect-data/azurehound-data-permissions)
