...
After completion, see the job's status in the **Finished Jobs Log** by clicking **Administration** > **Finished Jobs Log**. The _Status_ and _Status Message_ columns report on the job's completion.

<Frame>
  <img
    src="/images/data_collectors/finished-jobs-on-demand-scan.png"
    alt="A finished jobs log showing the status of an on demand scan"
  />
</Frame>
