...
5. In the *Schedule* window, configure the schedule:
   ...
   * **Data**: The type of data the schedule collects, see [SharpHound Data Collection and Permissions](/collect-data/operations/permissions)
   * **Advanced Options**: See the [Scanning section in the article SharpHound Enterprise Tenant Configuration](/collect-data/sharphound/install/configure-tenant)
