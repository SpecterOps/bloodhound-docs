---
title: Ad-hoc BHE Data Collection (using SharpHound CE)
---
...
It should be used by BloodHound Enterprise users who cannot deploy [SharpHound Enterprise](/collect-data/sharphound/install/system-requirements), for example in:
...
2. Choose a data collection method
   ...
   * Learn about collection methods and flags:
     * [SharpHound Community Edition](/collect-data/community/sharphound)
     * [All SharpHound Community Edition Flags, Explained](/collect-data/community/sharphound-flags)
     * [SharpHound Data Collection and Permissions](/collect-data/operations/permissions)
