---
title: Schedule Multiple AzureHound Enterprise Collectors
---
...
1. Follow the [AzureHound Enterprise System Requirements and Deployment Process](/collect-data/azurehound/install/system-requirements) through deployment in step 3. Deploy and maintain AzureHound: [Run and Upgrade AzureHound (Windows, Docker, or Kubernetes).](/collect-data/azurehound/install/installation-options)
