...
1. Configure Entra ID and Azure: [AzureHound Enterprise Azure Configuration](/collect-data/azurehound/install/azure-configuration)
2. Create your AzureHound configuration: [Create an AzureHound Configuration](/collect-data/azurehound/install/create-configuration)
3. Deploy and maintain AzureHound: [Run and Upgrade AzureHound (Windows, Docker, or Kubernetes)](/collect-data/azurehound/install/installation-options)
