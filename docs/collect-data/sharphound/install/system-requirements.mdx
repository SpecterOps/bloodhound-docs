---
title: System Requirements and Deployment Process
---
...
2. Create a Service Account or [gMSA](/collect-data/sharphound/install/configure-gmsa) that SharpHound will run as with the Service Account Requirements below.
3. [Install and Upgrade SharpHound Enterprise](/collect-data/sharphound/install/install-and-upgrade)
4. [Create a BloodHound Enterprise collector client](/collect-data/operations/create-collector)
5. [Run an On Demand Scan](/collect-data/operations/on-demand-scan) or [Create a data collection schedule](/collect-data/operations/collection-schedule)
...
* \[Optional] If performing privileged collection (see [Why perform privileged collection in SharpHound](/collect-data/operations/privileged-collection))
...
* \[Optional] If performing DC Registry and CA Registry collection (see [DC Registry and CA Registry details](/collect-data/operations/permissions))
...
See [SharpHound Data Collection and Permissions](/collect-data/operations/permissions) for comprehensive requirement information.
