...
>
  ...
  <CardGroup cols={4}>
    ...
    <Card title="Install a Data Collector" icon="folder" href="/collect-data/azurehound/overview" iconType="solid">
    ...
    <Card title="OpenGraph" icon="diagram-project" href="/core-concepts/opengraph/overview" iconType="solid">
