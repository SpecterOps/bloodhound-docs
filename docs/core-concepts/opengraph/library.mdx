...
<AccordionGroup>
  ...
  <Accordion title="Active Directory (AD)" icon={<SO_Icon />}>
    ...
    * [https://github.com/martinsohn/ManagerOfHound](https://github.com/martinsohn/ManagerOfHound)
  </Accordion>
  ...
  <Accordion title="Ping" icon={<SO_Icon />}>
    ...
    * [https://github.com/andyrobbins/PingOneHound](https://github.com/andyrobbins/PingOneHound)
  </Accordion>
  ...
  <Accordion title="runZero" icon="people-group">
    ...
    * [https://github.com/runZeroInc/runZeroHound/](https://github.com/runZeroInc/runZeroHound/)
  </Accordion>
  ...
  <Accordion title="Windows" icon="people-group">
    ...
    * [https://github.com/1r0BIT/TaskHound](https://github.com/1r0BIT/TaskHound)
  </Accordion>
</AccordionGroup>
...
A Python library for creating BloodHound OpenGraph JSON data that conforms to the BloodHound OpenGraph [schema specification](/core-concepts/opengraph/schema).
...
* [https://github.com/TheManticoreProject/gopengraph/](https://github.com/TheManticoreProject/gopengraph/)
