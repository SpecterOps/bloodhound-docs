...
<Update label="BloodHound" tags={["Fixed Issues"]}>
  ...
  - {/*BED-8026*/} Resolved an issue where selecting a node that has an `id` property from the explore table results in an error and does not load the object information.
