...
<Update label="BloodHound" description="New Feature" tags={["OpenGraph"]}>
  ...
  [Dynamic Markdown](/opengraph/developer/entity-panel-content#dynamic-entity-panel-content) supports node and relationship properties, conditional content, and supported helper functions.
</Update>
