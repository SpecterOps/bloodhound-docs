...
<Update label="AzureHound" description="Enhancement" tags={["Data Collection"]}>
  ...
  ## AzureHound Configuration Updates
...
<Update label="BloodHound" tags={["Fixed Issues"]}>
  ...
  {/*BED-7170*/} Resolved an issue where lazy-loading components caused UI crashes on browser refresh. Updated lazy loading patterns to avoid 429 errors when fetching shared UI components, improving application stability. 
