...
<Update label="BloodHound" description="Enhancement" tags={["OpenGraph"]}>
  ...
  **WIP**: I can't reproduce this. Is it ready for 8.5.0 or is it coming later?
...
<Update label="BloodHound" description="New Feature" tags={["API"]}>
  ...
  List asset group tag selector member count by kind

  GET `/api/v2/asset-group-tags/{asset_group_tag_id}/selectors/{asset_group_tag_selector_id}/members/counts`
