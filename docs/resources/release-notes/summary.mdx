...
| OpenGraph | [OpenGraph Extension Management](/resources/release-notes/2026-04-13#bloodhound-2) | Manage OpenGraph extensions with a new Administration page. Contact your account team to enable. |
...
| Explore (Community) | [Cypher Query Timeout Controls](/resources/release-notes/2026-04-13#bloodhound-9) | Optionally disable the default query timeout on a per-query basis for long-running Cypher queries. |
