...
| Data Collection | [Separate OpenHound Configuration and Secrets](/resources/release-notes/2026-07-28#separate-openhound-configuration-and-secrets) | Define the BloodHound Enterprise destination URL as configuration while keeping collector credentials in secrets files. |
