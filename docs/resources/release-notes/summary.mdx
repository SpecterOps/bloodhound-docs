...
This release introduces new features, enhancements, and fixes across BloodHound and AzureHound to improve usability, performance, and data collection. Key highlights include:
...
- Stability: Browser refresh no longer crashes the app; OpenGraph ingestion handles partial failures; pathfinding suggestions stop showing unknown edges. See [BloodHound fixes](/resources/release-notes/2026-01-22#bloodhound-12).
- Scale and accuracy: Zone Builder now respects connection limits, reports totals accurately across domains, and honors Cypher-based rule analysis. See [BloodHound fixes](/resources/release-notes/2026-01-22#bloodhound-12).
