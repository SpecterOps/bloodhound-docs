...
| Post-Processing | [Optimized Graph Indices](/resources/release-notes/2026-05-05#optimized-graph-indices) | Faster graph traversal and pathfinding from improved index coverage on edge data. |
| Post-Processing | [Incremental Edge Updates](/resources/release-notes/2026-05-05#incremental-edge-updates) | Selected edge types now update incrementally during post-processing, reducing unnecessary writes. |
