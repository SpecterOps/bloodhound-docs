...
| Component | Update | Summary |
| --- | --- | --- |
| OpenGraph | [Property-Based Edge Matching](/resources/release-notes/2026-03-23#bloodhound-2) | New property-based matching improves cross-source edge mapping, but may require update to your OpenGraph data payloads. |
