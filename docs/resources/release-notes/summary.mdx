...
This release improves graph investigation workflows in **Explore**, improves graph performance, and resolves reliability issues in findings export, Zone Builder tagging and filtering, and query naming. Key highlights include:
...
- Graph calculations use less CPU and memory so large graphs load faster and remain more responsive.
...
| --- | --- | --- |
| Explore | [Table Column Resizing](/resources/release-notes/2026-03-02#bloodhound) | Resize columns in the table layout graph view to review data more comfortably on smaller screens without changing window size. |
| Explore | [Meta Node Information in Entity Panel](/resources/release-notes/2026-03-02#bloodhound-2) | Review Meta node details in the **Entity Panel** without encountering errors. |
| Explore | [Improved Edge Information](/resources/release-notes/2026-03-02#bloodhound-3) | Review clearer and more consistent edge guidance for AZOwner, AZOwns, and key Entra ID role edges, plus valid node relationships and supported edge types with a new `valid_edges.json` schema. |
| Performance | [Graph Speed and Responsiveness](/resources/release-notes/2026-03-02#bloodhound-4) | Explore large graphs faster with smoother, more responsive interactions. |

### <Icon icon="wrench" /> Fixed Issues

See the [release notes](/resources/release-notes/2026-03-02#bloodhound-5) for a full list of fixed issues in this release.
