...
Check back here regularly for the latest announcements and updates regarding BloodHound product releases, SpecterOps events, and other important news.
...
This release makes the **Findings Table** feature generally available and expands Active Directory collection and analysis with new Sites data. It also improves accessibility, collector administration, Explore, and API workflows.

Key highlights include:

- **Findings Table**: Triage findings with cross-platform indicators, clearer status, and copy actions.
- **Active Directory Sites**: Collect and analyze Site, SiteServer, and SiteSubnet objects, including site-linked GPOs, ACLs, and ServerIs relationships.
- **Collection and administration**: Configure exact custom client identifiers for Integrated Windows Authentication (IWA) and manage collector schedules and support bundles more efficiently.

### <Icon icon="sparkles" /> New Features

| Component | Update | Summary |
| --- | --- | --- |
| Attack Paths | [Findings Table](/resources/release-notes/2026-10-05#findings-table-general-availability) | Triage Attack Path findings with clearer status and platform indicators, plus copy actions for selected asset information. |
| Attack Paths | [Findings Prioritization](/resources/release-notes/2026-10-05#findings-prioritization-early-access) | Use risk-based guidance to prioritize findings for triage and remediation. |

### <Icon icon="check-circle" /> Enhancements

| Component | Update | Summary |
| --- | --- | --- |
| Data Collection | [Active Directory Sites support](/resources/release-notes/2026-10-05#active-directory-sites-support) | Analyze Sites, SiteServers, SiteSubnets, site-linked GPOs, ACLs, and `ServerIs` relationships in BloodHound. |
| Data Collection | [Active Directory Sites collection](/resources/release-notes/2026-10-05#active-directory-sites-collection) | Collect Active Directory Sites, SiteServers, SiteSubnets, their mappings, site-linked GPOs, and Site ACLs with SharpHound v2.17.0. |
| Data Collection | [Active Directory collection coverage](/resources/release-notes/2026-10-05#active-directory-collection-coverage) | Collect the Builtin container and the underlying AD `objectClass` for collected nodes. |
| Accessibility | [Responsive and accessible workflows](/resources/release-notes/2026-10-05#responsive-and-accessible-workflows) | Improve reflow, navigation, headings, keyboard table navigation, and high-zoom behavior. |
| Explore | [More useful Explore search results](/resources/release-notes/2026-10-05#more-useful-explore-search-results) | Distinguish duplicate names and keep node-kind tooltip labels visible in search results. |
| Explore | [Explicit empty values in the Entity Panel](/resources/release-notes/2026-10-05#explicit-empty-values-in-the-entity-panel) |Always show properties even if their values contain empty arrays, strings, and null values to be explicit about null or empty cases. |
| Administration | [Database Management access control](/resources/release-notes/2026-10-05#database-management-access-control) | Limit destructive Database Management controls to administrators. |
| Administration | [Custom client identifiers for IWA authentication](/resources/release-notes/2026-10-05#custom-client-identifiers-for-iwa-authentication) | Configure optional custom client identifiers to control how BloodHound Enterprise resolves SharpHound Enterprise collector clients. |
| Data Collection | [Cleaner collector scheduling dialogs](/resources/release-notes/2026-10-05#cleaner-collector-scheduling-dialogs) | Manage collector schedules with clearer fields, responsive layouts, and more useful time zone and option labels. |
| Data Collection | [Faster support bundle creation](/resources/release-notes/2026-10-05#faster-support-bundle-creation) | Create SharpHound Enterprise collector support bundles faster by skipping recompression of existing log archives. |
| Cypher | [Parameterized PostgreSQL query formatting](/resources/release-notes/2026-10-05#parameterized-postgresql-query-formatting) | Keep generated query text separate from literal values while preserving query behavior. |
| API | [Archived finding timestamps in the API](/resources/release-notes/2026-10-05#archived-finding-timestamps-in-the-api) | Expose `archived_at` for archived Attack Path findings. |

### <Icon icon="wrench" /> Fixed Issues

See the [release notes](/resources/release-notes/2026-10-05#fixed-issues) for the full list of fixed issues in this release.
...
| Component | Update | Summary |
| --- | --- | --- |
| OpenHound GitHub Collector | [Workflow and runner visibility](/resources/release-notes/2026-09-17#workflow-and-runner-visibility) | Model runner eligibility, effective workflow permissions, job interception, secret access, and environment OIDC capabilities. |
| OpenHound GitHub Collector | [Credentials and access](/resources/release-notes/2026-09-17#credentials-and-access) | Normalize credential permissions and collect repository deploy-key metadata. |
| OpenHound GitHub Collector | [Collection and identity improvements](/resources/release-notes/2026-09-17#collection-and-identity-improvements) | Improve deployment detection, collection efficiency, organization role naming, immutable ID correlation, and source filtering. |
| OpenHound Okta Collector | [Shared trusted SAML issuers](/resources/release-notes/2026-09-17#shared-trusted-saml-issuers) | Preserve shared issuer identity, tenant isolation, and trust provenance across Okta identity providers. |
| OpenHound Okta Collector | [Per-node source kinds](/resources/release-notes/2026-09-17#per-node-source-kinds) | Distinguish native Okta nodes from normalized SAML nodes for source-specific filtering. |
| OpenHound Okta Collector | [Optional collection performance telemetry](/resources/release-notes/2026-09-17#optional-collection-performance-telemetry) | Diagnose and tune Okta collections with bounded, disabled-by-default performance telemetry. |

### <Icon icon="wrench" /> Fixed Issues

See the [release notes](/resources/release-notes/2026-09-17#client-management-and-s3-ingest) for the full list of fixed issues in this release.
...
| Attack Paths | [Findings Table](/resources/release-notes/2026-09-08#findings-table-early-access) | Filter findings by cross-platform status and Attack Path type, review result context, and pivot to remediation or Explore. |
...
<Callout color="#8E92EB">
  ...
  Triage Attack Path findings at scale with the new [Findings Table](/resources/release-notes/2026-08-18#findings-table-beta) (beta) on the **Attack Paths** page.
</Callout>
...
| Component | Update | Summary |
| --- | --- | --- |
| OpenGraph | [Extension Management Enabled by Default](/resources/release-notes/2026-08-18#extension-management-enabled-by-default) | Manage OpenGraph extensions without having to manually enable the feature. |
| OpenGraph | [OpenGraph Markdown Validation](/resources/release-notes/2026-08-18#opengraph-markdown-validation) | Upload extension definition schemas with more confidence that custom Markdown content can render safely in BloodHound. |
| API | [Kind Metadata APIs](/resources/release-notes/2026-08-18#kind-metadata-apis) | Retrieve node and relationship kind details by graph-assigned kind ID for OpenGraph automation and integrations. |
| PostgreSQL | [PostgreSQL Graph Storage Optimization](/resources/release-notes/2026-08-18#postgresql-graph-storage-optimization) | Get more reliable PostgreSQL graph database performance with storage optimization that runs after ingest and analysis. |
| Database Management | [Faster Graph Data Deletion](/resources/release-notes/2026-08-18#faster-graph-data-deletion) | Delete graph data from PostgreSQL-backed environments more quickly with **Database Management**. |
| Data Collection | [Collector Compatibility for Case-Sensitive Object IDs](/resources/release-notes/2026-08-18#collector-compatibility-for-case-sensitive-object-ids) | Learn how to keep collector output compatible with case-sensitive OpenGraph Object ID ingest. |
| OpenHound GitHub Collector | [GitHub Self-Hosted Runner Modeling](/resources/release-notes/2026-08-18#github-self-hosted-runner-modeling) | Identify membership, delegation, and access paths for enterprise and organization-scoped GitHub Actions self-hosted runners and runner groups. |

### <Icon icon="wrench" /> Fixed Issues

See the [release notes](/resources/release-notes/2026-08-18#cypher) for a full list of fixed issues in this release.
...
| Component | Update | Summary |
| --- | --- | --- |
| OpenHound GitHub Collector | [GitHub Enterprise SSO, SCIM, and Environment Data](/resources/release-notes/2026-08-04#github-enterprise-sso-scim-and-environment-data) | Identify identity, deployment, secret-access, and privilege escalation paths across GitHub enterprises and organizations. |
| OpenHound Okta Collector | [Okta Collector Parity Improvements](/resources/release-notes/2026-08-04#okta-collector-parity-improvements) | Analyze Okta environments with reworked role assignments, resource sets, hybrid auth, and normalized SAML modeling. |
...
| Component | Update | Summary |
| --- | --- | --- |
| Data Collection | [Analyze ADCS ESC14 Scenario A Attack Paths](/resources/release-notes/2026-07-29#analyze-adcs-esc14-scenario-a-attack-paths) | Identify certificate-mapping takeover paths involving write access to `altSecurityIdentities` or the Public-Information property set. |
| OpenGraph | [OpenGraph Entity Info](/resources/release-notes/2026-07-29#opengraph-entity-info) | See rich, extension-defined context for OpenGraph nodes and relationships directly in the Entity Panel. |

### <Icon icon="check-circle" /> Enhancements

| Component | Update | Summary |
| --- | --- | --- |
| OpenGraph | [OpenGraph Data Quality Statistics](/resources/release-notes/2026-07-29#opengraph-data-quality-statistics) | Review node-count statistics for OpenGraph environments and aggregate counts across extension kinds. |
| Data Collection | [Case-Sensitive OpenGraph Object IDs](/resources/release-notes/2026-07-29#case-sensitive-opengraph-object-ids) | Preserve distinct OpenGraph objects whose `objectid` values differ only by case while keeping AD and Entra ID ingest behavior case-insensitive. |
| Accessibility | [Accessibility and Contrast Improvements](/resources/release-notes/2026-07-29#accessibility-and-contrast-improvements) | Navigate BloodHound with improved contrast, clearer focus states, and indicators that do not rely on color alone. |
| Administration | [Separate OpenHound Configuration and Secrets](/resources/release-notes/2026-07-29#separate-openhound-configuration-and-secrets) | Define the BloodHound Enterprise destination URL as configuration while keeping collector credentials in secrets files. |
| Administration | [Upload-Only Role Access Enforcement](/resources/release-notes/2026-07-29#upload-only-role-access-enforcement) | Prevent upload-only users from accessing analysis pages outside their role permissions. |
| Administration | [Auditor SSO Configuration Access](/resources/release-notes/2026-07-29#auditor-sso-configuration-access) | Allow auditors to review SSO provider configuration without granting provider management permissions. |
| API | [Attack Path Findings API Availability](/resources/release-notes/2026-07-29#attack-path-findings-api-availability) | Retrieve unified, paginated Attack Path findings. |
| Zone Builder | [Privilege Zone Review Improvements](/resources/release-notes/2026-07-29#privilege-zone-review-improvements) | Review certifications and rules with clearer table behavior, more usable layouts, and better validation feedback. |

### <Icon icon="wrench" /> Fixed Issues

See the [release notes](/resources/release-notes/2026-07-29#api-and-access-control) for a full list of fixed issues in this release.
