...
This release introduces security-focused API controls, expands OpenGraph and collector capabilities, improves explore and ingestion workflows, and resolves high-impact API and query reliability issues.

### <Icon icon="sparkles" /> New Features

| Component | Update | Summary |
| --- | --- | --- |
| Administration | [API Key Expiration](/resources/release-notes/2026-04-13#bloodhound) | Configure automatic token expiration to reduce long-lived credential risk across personal and integration API keys. |
| Data Collection | [OpenHound Data Collector Framework](/resources/release-notes/2026-04-13#openhound) | Build and run standardized OpenGraph data collectors and converters for GitHub, Jamf, and Okta workloads. |
| OpenGraph | [OpenGraph Extension Management](/resources/release-notes/2026-04-13#bloodhound-2) | Upload, view, update, and delete OpenGraph extensions with new management APIs and experimental OpenAPI coverage. |
| OpenGraph | [OpenGraph Data Validation](/resources/release-notes/2026-04-13#bloodhound-3) | Validate payloads before ingestion with `chow` to catch schema errors early and reduce retry cycles. |
| OpenGraph (Enterprise) | [OpenGraph Findings](/resources/release-notes/2026-04-13#bloodhound-4) | Analyze custom graph findings in Attack Paths and Posture with extension-specific schema and path export APIs. |
| Administration (Enterprise) | [Environment Targeted Access Control (ETAC)](/resources/release-notes/2026-04-13#bloodhound-5) | Scope User and Read-only access by environment with dynamic policy controls in BloodHound Enterprise. |
| Data Collection (Enterprise) | [SharpHound Integrated Windows Authentication](/resources/release-notes/2026-04-13#sharphound) | Authenticate SharpHound Enterprise with ADFS using IWA for streamlined Windows authentication workflows. |

### <Icon icon="check-circle" /> Enhancements

| Component | Update | Summary |
| --- | --- | --- |
| Data Collection | [Azure Hybrid Post-Processing Performance and Data Hygiene](/resources/release-notes/2026-04-13#bloodhound-6) | Improve hybrid processing performance and reduce graph churn from placeholder object creation. |
| Administration | [HasSession Edge Deletion](/resources/release-notes/2026-04-13#bloodhound-7) | Delete only HasSession edges from Database Management to refresh time-sensitive session data without clearing the entire graph. |
| Explore | [Explorer Visual Clarity and Panel Behavior](/resources/release-notes/2026-04-13#bloodhound-8) | Improve directional readability, label behavior, and entity panel state for clearer graph investigation workflows. |
| Explore | [Cypher Optional Match and Query Timeout Controls](/resources/release-notes/2026-04-13#bloodhound-9) | Improve `OPTIONAL MATCH` parity and optionally bypass query timeout enforcement when allowed by configuration. |
| Explore | [Table View Sorting and Column Organization](/resources/release-notes/2026-04-13#bloodhound-10) | Improve table sort discoverability and column organization for faster analysis of tabular results. |
| Explore | [Improved Graph Export Filenames](/resources/release-notes/2026-04-13#bloodhound-11) | Export graph files with more useful names to reduce repeated filename collisions. |
| OpenGraph | [OpenGraph Environment ID Property Standardization](/resources/release-notes/2026-04-13#bloodhound-12) | Standardize on `environmentid` for more consistent ingestion, indexing, and query behavior. |
| Accessibility | [Accessibility Labels and Non-Text Content](/resources/release-notes/2026-04-13#bloodhound-13) | Improve role/state/value semantics and non-text labeling for stronger assistive technology support. |
| Administration | [Navigation Bar Modernization](/resources/release-notes/2026-04-13#bloodhound-14) | Improve sidebar expand/collapse behavior with better persistence and navigation discoverability. |
| Administration | [Citrix RDP Support Default for New Environments](/resources/release-notes/2026-04-13#bloodhound-15) | Enable Citrix RDP support by default for new environments to reduce initial configuration friction. |
| Zone Builder | [Privilege Zone Certification Selection Behavior](/resources/release-notes/2026-04-13#bloodhound-16) | Improve selection and details-panel alignment during Privilege Zone certification workflows. |
| Posture (Enterprise) | [Posture Metric Precision and Custom Range Controls](/resources/release-notes/2026-04-13#bloodhound-17) | Improve metric precision and custom date-range validation for more reliable posture trend analysis. |

### <Icon icon="wrench" /> Fixed Issues

- [BloodHound fixed issues](/resources/release-notes/2026-04-13#bloodhound-18): API/Auth, Cypher/Explore, OpenGraph, and Privilege Zones/Posture fixes.
- [AzureHound fixed issue](/resources/release-notes/2026-04-13#azurehound): corrected `AZResourceGroupUserAccessAdmin` role filtering behavior.
