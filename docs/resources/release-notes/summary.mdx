...
- **Explore**: Style improvements with clearer node labels, bolder edges, and more intuitive object selection behavior.
- **Navigation**: Enhancements to the primary sidebar with more predictable expand and collapse behavior.
- **OpenHound**: A standardized data collector and converter framework for GitHub, Jamf, and Okta OpenGraph extensions.
...
| OpenGraph | [OpenGraph Extension Management](/resources/release-notes/2026-04-13#bloodhound-2) | Manage OpenGraph extensions with a new Administration page. |
...
| OpenGraph (Enterprise) | [OpenGraph Findings](/resources/release-notes/2026-04-13#bloodhound-4) | Analyze custom graph findings in Attack Paths and Posture with extension-specific schemas. |
| Administration (Enterprise) | [Environment Targeted Access Control](/resources/release-notes/2026-04-13#bloodhound-5) | Scope User and Read-only access by environment with dynamic policy controls. |
...
| Component | Update | Summary |
| --- | --- | --- |
| Explore | [Graph Readability Improvements](/resources/release-notes/2026-04-13#bloodhound-6) | Explore graphs with improved node labels, clearer directional arrows, and more intuitive selection behavior. |
| Explore | [Table View Column Organization](/resources/release-notes/2026-04-13#bloodhound-7) | Reorder and pin columns with drag-and-drop for faster analysis of tabular results. |
| Explore | [Improved Graph Export Filenames](/resources/release-notes/2026-04-13#bloodhound-8) | Export graph files with more useful names to reduce repeated filename collisions. |
| Explore | [Cypher Query Timeout Controls](/resources/release-notes/2026-04-13#bloodhound-9) | Optionally disable the default query timeout on a per-query basis for long-running Cypher queries. |
| OpenGraph | [Environment ID Property Standardization](/resources/release-notes/2026-04-13#bloodhound-10) | Standardize on `environmentid` for more consistent ingestion, indexing, and query behavior. |
| Administration | [Navigation Sidebar Modernization](/resources/release-notes/2026-04-13#bloodhound-11) | Navigate BloodHound more efficiently with a modernized sidebar. |
| Data Collection | [Azure Hybrid Post-Processing and Data Hygiene](/resources/release-notes/2026-04-13#bloodhound-12) | Keep hybrid Azure and Active Directory (AD) relationship data cleaner with less unnecessary graph churn during post-processing. |
| Administration | [HasSession Edge Deletion](/resources/release-notes/2026-04-13#bloodhound-13) | Delete only HasSession edges from the database to refresh time-sensitive session data without clearing the entire graph. |
| Administration | [Citrix RDP Support Default for New Environments](/resources/release-notes/2026-04-13#bloodhound-14) | Start new environments with Citrix RDP Support enabled by default to reduce setup friction where Citrix patterns are expected. |
| Accessibility | [Accessibility Improvements](/resources/release-notes/2026-04-13#bloodhound-16) | Navigate BloodHound more effectively with assistive technologies through clearer component naming and better non-text content labeling across the interface. |
| Zone Builder (Enterprise) | [Certification Selection Behavior](/resources/release-notes/2026-04-13#bloodhound-15) | Certify objects in Privilege Zones with clearer list selection behavior that stays aligned with the object details panel. |
| Posture (Enterprise) | [Posture Metric Abbreviation](/resources/release-notes/2026-04-13#bloodhound-17) | Analyze posture trends with more precise metric display. |
| Posture (Enterprise) | [Custom Range Validation](/resources/release-notes/2026-04-13#bloodhound-18) | Analyze posture trends with more reliable custom date/time range behavior. |

### <Icon icon="wrench" /> Fixed Issues

See the [release notes](/resources/release-notes/2026-04-13#bloodhound-19) for a full list of fixed issues in this release.
