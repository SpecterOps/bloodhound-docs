...
This release brings the OpenHound GitHub and Okta collectors closer to parity with their standalone counterparts (GitHound and OktaHound), expanding enterprise SSO, SCIM, and environment data collection for GitHub and reworking role assignment, resource set, and SAML modeling for Okta.

### <Icon icon="check-circle" /> Enhancements

| Component | Update | Summary |
| --- | --- | --- |
| OpenHound | [GitHub Enterprise SSO, SCIM, and Environment Data](/resources/release-notes/2026-08-04#github-enterprise-sso-scim-and-environment-data) | Identify identity, deployment, secret-access, and privilege escalation paths across GitHub enterprises and organizations. |
| OpenHound | [Okta Collector Parity Improvements](/resources/release-notes/2026-08-04#okta-collector-parity-improvements) | Analyze Okta environments with reworked role assignments, resource sets, hybrid auth, and normalized SAML modeling. |
