...
| No release     | No release     | v2.9.0         |

<Note>AzureHound v2.9.0 is immediately available for download in hosted BloodHound Enterprise tenants. This version will be bundled with the next container release for BloodHound Community Edition and on-premises BloodHound Enterprise customers.</Note>

### <Icon icon="sparkles" /> New Features

{/*specterops/azurehound/pull/152*/}

This release introduces a new [`--user-agent`](/collect-data/ce-collection/azurehound-flags#custom-user-agent) flag in AzureHound that allows you to set a custom User-Agent header for all HTTP requests.
...
| Data Collection | [Custom User-Agent](/resources/release-notes/2026-01-22#azurehound)                  | Customize the HTTP User-Agent header for evasion or identification.  |
