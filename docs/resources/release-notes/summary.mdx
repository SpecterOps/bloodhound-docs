...
| OpenGraph | [Extension Management](/resources/release-notes/2026-04-13#bloodhound-2) | Manage OpenGraph extensions with a new Administration page. Contact your account team to enable. |
| OpenGraph (Enterprise) | [Findings](/resources/release-notes/2026-04-13#bloodhound-3) | Analyze custom graph findings in Attack Paths and Posture with extension-specific schemas. |
| Administration (Enterprise) | [Environment Targeted Access Control](/resources/release-notes/2026-04-13#bloodhound-4) | Scope User and Read-only access by environment with dynamic policy controls. |
