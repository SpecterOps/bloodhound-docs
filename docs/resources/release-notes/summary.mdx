...
| 2026-09-11 | v9.7.1 | No release | No release | No release |

{/*BED-9698, BED-9700*/}
This release addresses an issue that caused unnecessary log noise from client management operations and routine S3 ingest diagnostic events.
