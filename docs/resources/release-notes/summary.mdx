...
| Explore | [Explicit empty values in the Entity Panel](/resources/release-notes/2026-10-05#explicit-empty-values-in-the-entity-panel) | Show empty arrays, strings, and null values so collected-node states remain visible during investigation. |
