...
This release introduces new options for data collection and adds improvements to Zone Builder rules testing and terminology consistency.

### <Icon icon="sparkles" /> New Features

| Component      | Update                                                                                 | Summary                                                                 |
| -------------- | -------------------------------------------------------------------------------------- | --------------------------------------------------------------------- |
| Data Collection | [User-Agent Flag for AzureHound](/resources/release-notes/2026-02-09#azurehound)        | Customize the User-Agent header used in AzureHound HTTP requests.     |

### <Icon icon="check-circle" /> Enhancements

| Component       | Update                                                                                 | Summary                                                                       |
| --------------- | -------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| Data Collection | [Last Sign-In from Azure](/resources/release-notes/2026-02-09#azurehound-2)             | Track user activity based on last successful sign-in timestamp from Entra ID. |
| Explore         | [Updated Permissions for Saved Cypher Queries](/resources/release-notes/2026-02-09#bloodhound) | User and Power User roles can now edit shared Cypher queries. |
| Zone Builder    | [Cypher Rule Testing](/resources/release-notes/2026-02-09#bloodhound-2)                 | Verify your Cypher query with a new Run button before creating rules.        |
| Zone Builder    | [Consistent Certification Terminology](/resources/release-notes/2026-02-09#bloodhound-3) | Revoke button renamed to Reject to align with status filter language.        |
| Zone Builder    | [Zone Name in Object Information](/resources/release-notes/2026-02-09#bloodhound-4)     | Quickly identify the zone name instead of position when viewing object information. |

### <Icon icon="wrench" /> Fixed Issues

<Badge shape="rounded" size="lg" color="purple">9</Badge> issues resolved in BloodHound.
