...
| 2026-03-25 | v8.9.1 | No release | No release |

This release resolves several issues that could cause analysis to fail.

- {/*BED-7722*/} Resolved an issue where deprecated SHA-1 cipher suites were available when BloodHound was configured to serve HTTPS directly (without a load balancer).
