...
<Warning>It also includes a [breaking change](/resources/release-notes/2026-03-23#bloodhound-2) for OpenGraph data payloads.</Warning>
...
| Component | Update | Summary |
| --- | --- | --- |
| OpenGraph | [Property-Based Edge Matching](/resources/release-notes/2026-03-23#bloodhound-2) | New property-based matching improves cross-source edge mapping, but may require updates to your OpenGraph data payloads. |
...
| Explore | [Search Component Styling Consistency](/resources/release-notes/2026-03-23#bloodhound-4) | Switch between Search, Pathfinding, and Cypher tabs without layout shift. |
| Explore | [Table Layout Scrollbar Visibility](/resources/release-notes/2026-03-23#bloodhound-5) | See and use scrollbars more reliably when table layout content overflows. |

### <Icon icon="wrench" /> Fixed Issues

<Badge shape="rounded" size="lg" color="purple">14</Badge> issues resolved across [BloodHound](/resources/release-notes/2026-03-23#bloodhound-6), [SharpHound](/resources/release-notes/2026-03-23#sharphound-2), and [AzureHound](/resources/release-notes/2026-03-23#azurehound-2).
