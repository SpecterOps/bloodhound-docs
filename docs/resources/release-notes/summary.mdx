...
| Cypher | [Relationship and Endpoint Filtering](/resources/release-notes/2026-05-26#relationship-and-endpoint-filtering) | Inspect relationships and their start and end nodes within matched paths. |
...
| OpenGraph | [Stronger OpenGraph Kind Validation](/resources/release-notes/2026-05-26#stronger-opengraph-kind-validation) | Update custom kinds if using the the reserved `tag_` prefix to avoid validation failures. |
| OpenGraph | [Updated Node Schema](/resources/release-notes/2026-05-26#updated-node-schema) | See how the `environmentid` and `collected` properties are used in the node JSON schema. |
