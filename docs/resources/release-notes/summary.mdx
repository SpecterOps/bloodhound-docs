...
This patch release improves graph investigation workflows in **Explore** and resolves reliability issues in query naming and **Zone Builder** tagging behavior.

### <Icon icon="check-circle" /> Enhancements

| Component | Update | Summary |
| --- | --- | --- |
| Explore | [Meta Node Information in Entity Panel](/resources/release-notes/2026-03-02#bloodhound) | Review Meta node details in the **Entity Panel** without encountering errors. |
| Explore | [Improved Edge Information](/resources/release-notes/2026-03-02#bloodhound-2) | Review clearer and more consistent edge guidance for AZOwner, AZOwns, and key Entra ID role edges. |

### <Icon icon="wrench" /> Fixed Issues

See the [release notes](/resources/release-notes/2026-03-02#bloodhound-3) for a full list of fixed issues in this release.
