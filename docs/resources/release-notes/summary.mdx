...
| Performance | [Graph Speed and Responsiveness](/resources/release-notes/2026-03-04#bloodhound-4) | Explore large graphs faster with smoother, more responsive interactions. |

### <Icon icon="wrench" /> Fixed Issues

See the [release notes](/resources/release-notes/2026-03-04#bloodhound-5) for a full list of fixed issues in this release.
