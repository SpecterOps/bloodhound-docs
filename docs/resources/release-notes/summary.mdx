...
| OpenGraph | [OpenGraph Entity Info](/resources/release-notes/2026-07-28#opengraph-entity-info) | See rich, extension-defined context for OpenGraph nodes and relationships directly in the Entity Panel. |
...
| API | [Attack Path Findings API Availability](/resources/release-notes/2026-07-28#attack-path-findings-api-availability) | Retrieve unified, paginated Attack Path findings. |
