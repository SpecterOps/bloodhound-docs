...
| OpenGraph | [Stronger OpenGraph Kind Validation](/resources/release-notes/2026-05-26#stronger-opengraph-kind-validation) | Update custom kinds if using the reserved `tag_` prefix to avoid validation failures. |
