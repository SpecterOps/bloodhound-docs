...
| Cypher | [Relationship and Node Filtering Support](/resources/release-notes/2026-05-26#relationship-and-endpoint-filtering) | Utilize `nodes()`, `relationships()`, `startNode()`, and `endNode` clauses in cypher to better match desired paths. |
| Cypher | [Path Node Inspection](/resources/release-notes/2026-05-26#path-node-inspection) | Use `nodes()` to access ordered nodes in a matched path. |
