...
This release improves ingest and post-processing performance for large datasets, smooths key Explore workflows, expands OpenGraph display and extension-management controls, and resolves broad reliability issues across API and authentication, graph processing, OpenGraph, the UI, and AzureHound. Key highlights include:

- **Ingest and Post-Processing**: Faster traversal paths and less post-processing churn for large datasets.
- **Explore Workflows**: Improved Cypher query results behavior, saved query organization, and Entity Panel controls.

### <Icon icon="check-circle" /> Enhancements

| Component | Update | Summary |
| --- | --- | --- |
| Administration | [Database Management](/resources/release-notes/2026-05-05#database-management) | Manage graph cleanup more predictably with HasSession deletion nested under the Active Directory data source. |
| Data Ingestion | [Ingest and Post-Processing](/resources/release-notes/2026-05-05#ingest-and-post-processing) | Reduce traversal cost and post-processing churn with broader index coverage and delta-based updates for selected post-processed edges. |
| Explore | [Cypher Query Results](/resources/release-notes/2026-05-05#cypher-query-results) | Adapt Entity Panel and sidebar behavior automatically based on whether a query returns one node or multiple nodes. |
| Explore | [Saved Query Subcategories](/resources/release-notes/2026-05-05#subcategories-for-saved-queries) | Browse saved queries with clearer subcategories and less repeated labeling. |
| Explore | [Entity Panel Controls](/resources/release-notes/2026-05-05#entity-panel-controls) | Use separate collapse and close controls to reduce accidental panel closures. |
| OpenGraph | [Custom Icons](/resources/release-notes/2026-05-05#custom-icons) | Apply default node icon and color from the display kind defined in an extension schema. |
| OpenGraph | [Extension Management API](/resources/release-notes/2026-05-05#extension-management-api) | Manage extensions with finer-grained API permissions for administration and schema access. |

### <Icon icon="wrench" /> Fixed Issues

See the [release notes](/resources/release-notes/2026-05-05) for a full list of fixed issues in this release.
