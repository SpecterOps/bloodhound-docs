...
| 2026-05-05 | v9.1.0 | No release | No release | v2.12.1 |

This release improves data ingest and graph processing performance, refines core Explore and Administration workflows, and resolves high-impact reliability issues across API, OpenGraph, and collection operations. Key highlights include:

- **Data Ingest and Post-Processing**: Improved index coverage for common traversal paths and introduced delta-change apply behavior for selected post-processed edges.
...
| --- | --- | --- |
| Data Ingestion | [Ingest and Post-Processing](/resources/release-notes/2026-05-05#bloodhound-2) | Process large datasets with faster traversal paths and reduced post-processing churn using delta-change apply behavior for selected edges. |
| Explore | [Cypher Query Results](/resources/release-notes/2026-05-05#cypher-query-results) | Work through Cypher results with adaptive panel behavior for single-node and multi-node results. |
| Explore | [Subcategories for Saved Queries](/resources/release-notes/2026-05-05#subcategories-for-saved-queries) | Navigate saved query categories with clearer grouping and reduced repeated labels. |
| Explore | [Entity Panel Controls](/resources/release-notes/2026-05-05#entity-panel-controls) | Use clearer collapse and close controls in the Entity Panel to reduce accidental closures. |
| OpenGraph | [Custom Icons](/resources/release-notes/2026-05-05#custom-icons) | Set default node icons and colors based on the `is_display_kind` field in an extension definition schema's `node_kinds` array. |
| OpenGraph | [Extension Management API](/resources/release-notes/2026-05-05#extension-management-api) | Manage extensions with more granular API permissions for administration and schema data access. |
| Administration | [Database Management](/resources/release-notes/2026-05-05#database-management) | Manage HasSession cleanup from a more consistent location in Database Management. |

### <Icon icon="wrench" /> Fixed Issues

See the [release notes](/resources/release-notes/2026-05-05#bloodhound-5) for a full list of fixed issues in this release.
