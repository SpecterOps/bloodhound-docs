...
This release adds Active Directory Sites collection and analysis, configurable IWA client identifiers, and more efficient Findings Table and accessibility workflows.

Key highlights include:

- **Active Directory Sites**: Collect Site, SiteServer, and SiteSubnet objects and analyze site-linked GPO and server relationships in BloodHound.
- **IWA client resolution**: Associate SharpHound Enterprise clients with exact values from a configured JWT claim or the token's `sub` claim.
- **Findings Table**: Control Findings Prioritization, identify cross-platform findings, understand finding state at a glance, and copy selected asset information.

### <Icon icon="sparkles" /> New Features

| Component | Update | Summary |
| --- | --- | --- |
| Data Collection | [Active Directory Sites support](/resources/release-notes/2026-10-05#active-directory-sites-support) | Collect and analyze Active Directory Sites, SiteServers, SiteSubnets, site-linked GPOs, and `ServerIs` relationships. |
| Administration | [Custom client identifiers for IWA authentication](/resources/release-notes/2026-10-05#custom-client-identifiers-for-iwa-authentication) | Resolve SharpHound Enterprise clients with a configured JWT claim or exact custom identifier. |
...
| Component | Update | Summary |
| --- | --- | --- |
| Attack Paths | [Findings Table workflow improvements](/resources/release-notes/2026-10-05#findings-table-workflow-improvements) | Control prioritization, identify cross-platform findings, distinguish finding states, and copy asset information. |
...
| Security | [Parameterized PostgreSQL query formatting](/resources/release-notes/2026-10-05#parameterized-postgresql-query-formatting) | Keep generated query text separate from literal values in the PostgreSQL path. |
