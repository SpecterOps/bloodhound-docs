...
| Explore | [Explorer Visual Clarity and Panel Behavior](/resources/release-notes/2026-04-13#bloodhound-7) | Improve directional readability, label behavior, and entity panel state for clearer graph investigation workflows. |
| Explore | [Cypher Optional Match and Query Timeout Controls](/resources/release-notes/2026-04-13#bloodhound-8) | Improve `OPTIONAL MATCH` parity and optionally bypass query timeout enforcement when allowed by configuration. |
| Explore | [Table View Sorting and Column Organization](/resources/release-notes/2026-04-13#bloodhound-9) | Improve table sort discoverability and column organization for faster analysis of tabular results. |
| Explore | [Improved Graph Export Filenames](/resources/release-notes/2026-04-13#bloodhound-10) | Export graph files with more useful names to reduce repeated filename collisions. |
| OpenGraph | [OpenGraph Environment ID Property Standardization](/resources/release-notes/2026-04-13#bloodhound-11) | Standardize on `environmentid` for more consistent ingestion, indexing, and query behavior. |
| Accessibility | [Accessibility Labels and Non-Text Content](/resources/release-notes/2026-04-13#bloodhound-12) | Improve role/state/value semantics and non-text labeling for stronger assistive technology support. |
| Administration | [Navigation Bar Modernization](/resources/release-notes/2026-04-13#bloodhound-13) | Improve sidebar expand/collapse behavior with better persistence and navigation discoverability. |
| Administration | [Citrix RDP Support Default for New Environments](/resources/release-notes/2026-04-13#bloodhound-14) | Enable Citrix RDP support by default for new environments to reduce initial configuration friction. |
| Zone Builder | [Privilege Zone Certification Selection Behavior](/resources/release-notes/2026-04-13#bloodhound-15) | Improve selection and details-panel alignment during Privilege Zone certification workflows. |
| Posture (Enterprise) | [Posture Metric Precision and Custom Range Controls](/resources/release-notes/2026-04-13#bloodhound-16) | Improve metric precision and custom date-range validation for more reliable posture trend analysis. |

### <Icon icon="wrench" /> Fixed Issues

- [BloodHound fixed issues](/resources/release-notes/2026-04-13#bloodhound-17): API/Auth, Cypher/Explore, OpenGraph, and Privilege Zones/Posture fixes.
