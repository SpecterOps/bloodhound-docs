...
This release introduces new authentication options for data collection and adds improvements to Zone Builder rules testing and terminology consistency.

### <Icon icon="sparkles" /> New Features

| Component      | Update                                                                                 | Summary                                                                 |
| -------------- | -------------------------------------------------------------------------------------- | --------------------------------------------------------------------- |
| Data Collection | [Integrated Windows Authentication for SharpHound](/resources/release-notes/2026-02-09#bloodhound) | Configure SharpHound Enterprise clients to authenticate via Active Directory Federation Services. |
...
<Badge shape="rounded" size="lg" color="purple">3</Badge> issues resolved in BloodHound.
