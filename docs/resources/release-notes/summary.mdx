...
| Zone Builder    | [Cypher Rule Testing](/resources/release-notes/2026-02-09#bloodhound)                 | Verify your Cypher query with a new Run button before creating rules.        |
| Zone Builder    | [Consistent Certification Terminology](/resources/release-notes/2026-02-09#bloodhound-2) | Revoke button renamed to Reject to align with status filter language.        |
| Zone Builder    | [Zone Name in Object Information](/resources/release-notes/2026-02-09#bloodhound-3)     | Quickly identify the name of the zone that an object belongs to instead of its position when viewing object information. |
