...
| Explore (Community) | [Cypher Query Timeout Bypass](/resources/release-notes/2026-04-13#bloodhound-9) | Allow individual Cypher queries to run past the default timeout when needed. |
