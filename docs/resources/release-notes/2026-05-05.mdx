...
<Update label="BloodHound" description="Enhancement" tags={["OpenGraph"]}>
  ...
  - Users with the Power User, Auditor, User, and Read-only roles can view installed extensions, findings, and edges.

  See [User Role Definitions](/manage-bloodhound/auth/users-and-roles#user-role-definitions) for a full breakdown of permissions.
</Update>
