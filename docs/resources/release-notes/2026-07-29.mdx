...
<Update label="BloodHound" description="New Feature" tags={["OpenGraph"]}>
  ...
  OpenGraph extensions can now define [custom entity panel content](/opengraph/developer/entity-panel-content#custom-entity-panel-content) for node and relationship kinds, including:
