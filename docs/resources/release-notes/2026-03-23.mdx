...
<Update label="AzureHound" description="New Feature" tags={["Data Collection"]}>
  ...
  Map trust relationships from external identity providers to Azure App Registrations with new OpenGraph nodes and edges representing Federated Identity Credentials (FICs).
