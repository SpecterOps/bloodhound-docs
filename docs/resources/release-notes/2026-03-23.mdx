...
<Update label="BloodHound" description="Enhancement" tags={["OpenGraph"]}>
  ...
  New [property-based edge matching](/opengraph/schema#edge-endpoint-matching) (`match_by: "property"`) enables hybrid edge creation using cross-system attributes, such as email, username, or hostname.
