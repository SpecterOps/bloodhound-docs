...
<Update label="BloodHound" description="General Availability" tags={["Zone Builder"]}>
  ...
  Privilege Zones is now generally available in BloodHound, providing a supported workflow for organizing objects by privilege level and monitoring violations of your network tiering model.

  See the [Privilege Zones](/analyze-data/privilege-zones/overview) to learn more.
</Update>
