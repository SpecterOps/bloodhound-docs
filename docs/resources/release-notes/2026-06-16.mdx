...
<Update label="BloodHound" description="Enhancement" tags={["OpenGraph"]}>
  {/*BED-8277*/}
  ## Built-in SpecterOps Extensions

  <img src="/assets/enterprise-edition-pill-tag.svg" alt="BloodHound Enterprise logo" style={{ width: "25%" }}/>

  BloodHound Enterprise now includes built-in SpecterOps OpenGraph extensions for GitHub, Jamf, and Okta. This streamlines extension management by making these supported extensions available without a separate installation step.
