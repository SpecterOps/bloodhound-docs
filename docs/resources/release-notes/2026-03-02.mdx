...
<Update label="BloodHound" description="Enhancement" tags={["Performance"]}>
  ...
  ## Graph Speed and Responsiveness

  {/*BED-7355*/} Explore large graphs faster with smoother performance.

  BloodHound now uses less CPU and memory during graph calculations, which helps large graphs load faster and keeps interactions more responsive.
