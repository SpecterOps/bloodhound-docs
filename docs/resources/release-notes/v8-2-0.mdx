...
- **Clarified that the Explore "Search" button** - We've clarified that the "Search" button on the bottom of the Explore page searches nodes within the currently displayed set of results. Using this action makes it quick and easy to identify a specific object of interest within the results of your query.
<Frame>
  <img src="/images/release_notes/8_2_0/8_2_node_search.png" alt="Clarified Explore Search button in BloodHound v8.2.0"/>
</Frame>
- **Table view, compacted** - The Table layout added in v8.0.0 was a bit sparse, so we've tightened it up to dislpay more data within the same screen space.
<Frame>
