...
description: "Principals with the Intune Administrator role in Microsoft Entra ID can execute arbitrary PowerShell scripts on devices joined to the tenant."
---
