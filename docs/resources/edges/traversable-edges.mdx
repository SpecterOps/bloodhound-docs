...
| [SyncedToEntraDSUser](/resources/edges/synced-to-entra-ds-user) | [AddEntraDSGroupMember](/resources/edges/add-entra-ds-group-member) | [SyncEntraDSUsers](/resources/edges/sync-entra-ds-users) |
