...
|                      |                           |                          |
|----------------------|---------------------------|--------------------------|
| AbuseTGTDelegation   | CanPSRemote               | ManageCA                 |
| ADCSESC1             | CanRDP                    | ManageCertificates       |
...
| ADCSESC3             | CoerceAndRelayNTLMToSMB   | PropagatesACEsTo         |
| ADCSESC4             | CoerceToTGT               | ReadGMSAPassword         |
| ADCSESC6a            | ContainsIdentity          | ReadLAPSPassword         |
...
| AddMember            | GenericAll                | WriteAccountRestrictions |
| AddSelf              | GenericWrite              | WriteDacl                |
| AdminTo              | GoldenCert                | WriteGPLink              |
| AllExtendedRights    | GPOAppliesTo              | WriteOwner               |
| AllowedToAct         | HasSIDHistory             | WriteOwnerLimitedRights  |
| AllowedToDelegate    | HasSession                | WriteSPN                 |
| CanApplyGPO          | HasTrustKeys              |                          |
...
|                          |                         |                                 |
|--------------------------|-------------------------|---------------------------------|
| Contains                 | GetChangesInFilteredSet | OwnsRaw                         |
| CrossForestTrust         | GPLink                  | PublishedTo                     |
| DelegatedEnrollmentAgent | HostsCAService          | RemoteInteractiveLogonPrivilege |
