...
|                          |                    |                                 |
| ------------------------ | ------------------ | ------------------------------- |
| DelegatedEnrollmentAgent | GetChanges         | OwnsRaw                         |
| Enroll                   | GetChangesAll      | ProtectAdminGroups              |
| EnrollOnBehalfOf         | GetChangesInFilteredSet | PublishedTo                 |
| EnterpriseCAFor          | HostsCAService     | RemoteInteractiveLogonRight     |
| ExtendedByPolicy         | IssuedSignedBy     | RootCAFor                       |
| LocalToComputer          | MemberOfLocalGroup | TrustedForNTAuth                |
| NTAuthStoreFor           | OIDGroupLink       | WritePKIEnrollmentFlag          |
|                          |                    | WritePKINameFlag                |
|                          |                    | WriteOwnerRaw                   |
