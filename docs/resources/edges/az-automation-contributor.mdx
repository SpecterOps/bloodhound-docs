...
description: "The Azure Automation Contributor role in Azure Resource Manager grants full control of the target Azure Automation account. This includes the ability to execute arbitrary commands on the Automation account."
---
