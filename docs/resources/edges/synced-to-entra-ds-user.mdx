...
BloodHound does not consider whether the Entra user is a B2B external identity when creating this relationship. A B2B external identity will be synchronized to Entra DS but cannot authenticate to the managed domain by design.
