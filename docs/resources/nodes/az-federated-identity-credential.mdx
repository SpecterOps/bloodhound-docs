...
description: "The AZFederatedIdentityCredential node represents a Federated Identity Credential configured on an application registration in Microsoft Entra ID."
