...
To help you find the right query quickly, BloodHound offers the following search and filter options:
...
As you create custom queries, BloodHound provides several features to help you manage them:
