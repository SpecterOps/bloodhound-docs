...
<Note>
  You must enable the `CREATE` clause by setting `enable_cypher_mutations: true` in your BloodHound [configuration file](/manage-bloodhound/bh-config#enable_cypher_mutations).
</Note>
...
<Note>
  You must enable the `SET` clause by setting `enable_cypher_mutations: true` in your BloodHound [configuration file](/manage-bloodhound/bh-config#enable_cypher_mutations).
</Note>
...
<Note>
  You must enable the `DELETE` clause by setting `enable_cypher_mutations: true` in your BloodHound [configuration file](/manage-bloodhound/bh-config#enable_cypher_mutations).
</Note>
