...
<Note>BloodHound supports all search methods for [structured](/opengraph/extensions/manage#structured-graphs) graphs. If you're exploring [structured](/opengraph/extensions/manage#generic-graphs) graphs, you can use the **Search** and **Cypher** search methods only.</Note>
...
<Note>Pathfinding is available for [structured](/opengraph/extensions/manage#structured-graphs) graphs.</Note>
