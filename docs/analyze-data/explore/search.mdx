...
You can interact with nodes and edges in the graph to view detailed information about them in the **Entity** panel. For nodes, you can right-click to perform more actions using the [context menu](/analyze-data/explore/search#context-menu).
