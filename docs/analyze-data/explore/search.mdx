...
You can include up to three destination nodes in a single search, which is useful for investigating potential attack paths across identity providers and cloud services in a single graph view.
