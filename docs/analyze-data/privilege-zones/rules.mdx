...
When an object matches rules in multiple zones, only the highest-priority zone in your [**Zone Order**](/analyze-data/privilege-zones/zones) claims that object. Lower-priority zones won't display the object, even if their rules match.
