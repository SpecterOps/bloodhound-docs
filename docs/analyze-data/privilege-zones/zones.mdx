...
<Steps>
  <Step title="Select a zone">
   Navigate to the **Zones** tab, select the zone you want to edit, and click **Edit Zone**.
  </Step>
  ...
  <Step title="Edit the zone">
    ...
    <Tabs>
      <Tab title="BloodHound Enterprise">
        To edit the zone:
          ...
          1. You can also change the zone's hierarchical position by using the vertical grip control (<Icon icon="grip-vertical" iconType="solid" />) in the **Zone Order** panel to reorder it.
      ...
      <Tab title="BloodHound Community Edition">
        In BloodHound Community Edition, you can edit the default **Tier Zero** zone description.

        <Tip>To manage how objects are included in the zone, see [Rules](/analyze-data/privilege-zones/rules).</Tip>
      </Tab>
    </Tabs>
  </Step>
...
<Note>You cannot delete the default **Tier Zero** zone, but you can edit its properties. See [Modify Tier Zero](/get-started/security-boundaries/modifying-tier-zero) for more information.</Note>
