...
<Callout color="#8E92EB">
  ...
  If you enable [Variable Analysis Mode](/analyze-data/findings/analysis#variable-analysis-mode), BloodHound Enterprise can complete analysis for Privilege Zone changes faster because it starts at the **Tagging** stage instead of running the full analysis pipeline.
