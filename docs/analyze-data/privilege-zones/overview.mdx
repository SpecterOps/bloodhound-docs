...
The **Zone Builder** page provides tools for configuring and managing your privilege zones. Once configured, BloodHound analyzes your zones and displays findings in the **Attack Paths** and **Posture** pages.
...
* **Certification** <Badge shape="rounded" size="sm" stroke color="purple">Enterprise Edition</Badge>: An optional process to interrupt automatic inclusion of additional objects in a zone by requiring manual certification of the additional objects
