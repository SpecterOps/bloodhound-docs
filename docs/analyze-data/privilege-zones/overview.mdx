...
<Callout color="#8E92EB">
  ...
  BloodHound Enterprise can complete analysis for Privilege Zone changes faster with [Variable Analysis Mode](/analyze-data/findings/analysis#variable-analysis-mode) because it starts at the **Tagging** stage instead of running the full analysis pipeline.
