...
1. Create a [zone](/analyze-data/privilege-zones/zones) around those GitHub objects.
1. Analyze who or what can control the zone.
1. Validate [findings](/analyze-data/findings/attack-paths) with application, platform, DevOps, and cloud owners.
