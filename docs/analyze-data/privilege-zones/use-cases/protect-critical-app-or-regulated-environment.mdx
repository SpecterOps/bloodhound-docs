...
1. Create a [zone](/analyze-data/privilege-zones/zones) using known objects, OUs, naming conventions, or Cypher.
1. Review [attack paths](/analyze-data/findings/attack-paths) into the zone.
