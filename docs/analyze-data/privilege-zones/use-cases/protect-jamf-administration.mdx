...
1. Create a zone around the high-impact Jamf objects.
...
### Starter Cypher: Jamf Tier Zero principals
...
### Starter Cypher: all Jamf computers
...
### Starter Cypher: all Jamf groups
...
### Starter Cypher: Jamf API client immediate edges
...
### Starter Cypher: Jamf account paths
...
### Starter Cypher: Jamf account to tenant edges
...
### Starter Cypher: Jamf group edges to accounts
...
### Starter Cypher: Tier One to Tier Zero Jamf paths

#### CySQL issue with TraversableEdges: "AND r.traversable = True"

###### getting variable-length relationship binding e0 is a list and does not support direct property lookup
...
### Starter Cypher: direct Tier One to Tier Zero Jamf edges
...
### Starter Cypher: Jamf sensitive endpoint discovery

###### Many companies use serial numbers for naming schemes, however some companies naming schemes would match the below.
