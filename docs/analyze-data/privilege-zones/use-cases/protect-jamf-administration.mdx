...
1. Create a [zone](/analyze-data/privilege-zones/zones) around the high-impact Jamf objects.
1. Review [attack path](/analyze-data/findings/attack-paths) into the zone.
