...
1. Define a Tier One [zone](/analyze-data/privilege-zones/zones) around administrative systems or critical infrastructure.
1. Define a [zone](/analyze-data/privilege-zones/zones) around a specific business-critical application or regulated system.
1. Use [labels](/analyze-data/privilege-zones/labels) or [zones](/analyze-data/privilege-zones/zones) to map ownership across business units or platform teams.
1. Add [OpenGraph-connected technologies](/opengraph/extensions/manage), such as GitHub, Jamf, Okta, or cloud platforms.
