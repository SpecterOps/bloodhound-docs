...
1. Create a Privilege Zone around those assets.
1. Review findings and identify the highest-value remediation actions.
1. Assign remediation owners.
1. Track reduction in attack paths over the campaign period.
...
### Starter Cypher: migration or acquisition campaign discovery
...
### Starter Cypher: audit or compliance campaign discovery
...
### Starter Cypher: review immediate inbound relationships to campaign assets
...
### Starter Cypher: review multi-hop paths into campaign assets
