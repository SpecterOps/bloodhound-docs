...
1. Create a [zone](/analyze-data/privilege-zones/zones) around those assets.
1. Review [findings](/analyze-data/findings/attack-paths) and identify the highest-value remediation actions.
1. Assign remediation owners.
1. Track [reduction](/analyze-data/findings/posture) in attack paths over the campaign period.
