...
To edit an existing label, follow these steps:

<Steps>
  <Step title="Select a label">
   Navigate to the **Labels** tab, select the label you want to edit, and click **Edit Label**.
  </Step>
...
<Note>You cannot delete the default **Owned** label, but you can edit its description and rules.</Note>
