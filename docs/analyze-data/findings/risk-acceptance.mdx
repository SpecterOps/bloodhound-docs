...
The **Attack Paths** page in BloodHound Enterprise surfaces findings — specific instances of vulnerabilities where a lower-privileged entity can gain access to a sensitive resource. Each finding includes prioritization data such as exposure and impact metrics to help you focus remediation efforts where they matter most.

Not every finding requires immediate remediation. Risk acceptance lets you acknowledge a finding as a known risk that your organization has reviewed and chosen to retain for certain amount of time.
