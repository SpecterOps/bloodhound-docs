...
In the [Overview](/on-premises/overview), we covered the high-level overview of the embedded cluster deployment option for on-premises instances of BloodHound Enterprise. This guide provides step-by-step instructions for installing and configuring BloodHound Enterprise with the embedded cluster installer.
...
- Stand up a [reverse proxy](/on-premises/system-requirements#reverse-proxy) with your SSL certificate to terminate HTTPS in front of BloodHound Enterprise
