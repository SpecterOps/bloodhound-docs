...
In the [Deployment Overview](/on-premises/embedded-cluster/overview), we covered the high-level overview of the embedded cluster deployment option for on-premises instances of BloodHound Enterprise. This guide provides step-by-step instructions for installing and configuring BloodHound Enterprise with the embedded cluster installer.
