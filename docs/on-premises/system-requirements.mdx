...
Create one `A` record that resolves the BloodHound Enterprise FQDN to the reverse proxy IP address. The record must be resolvable from both user workstations and collector hosts.
