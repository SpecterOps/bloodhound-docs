...
By default, all users will utilize username and password via the built-in authentication service. When creating or modifying a user, you will be granted the option to change this setting. When creating a new {auth_mode} user, you must ensure the {auth_mode} user does not share email with any built-in users.
