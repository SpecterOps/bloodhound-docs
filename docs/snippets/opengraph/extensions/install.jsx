...
export const InstallExtension = ({ source, env, schemaUrl }) => {
  return (
    <>
      <p>
        The {source} extension includes a schema that tells BloodHound how to model and analyze data from your {source} {env}. You must install the extension before you upload data generated by a collector.
      </p>
