...
<Note>
  Users must also create Privilege Zone [rules](/analyze-data/privilege-zones/rules) _after_ installing an extension and _prior_ to uploading a data payload to see findings in BloodHound Enterprise.
</Note>
