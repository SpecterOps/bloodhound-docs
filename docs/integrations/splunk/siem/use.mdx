...
<Tip>You configure the [data inputs](/integrations/splunk/siem/install#configure-the-splunk-app-required) for these dashboards during the installation and configuration of the BloodHound Enterprise Splunk app.</Tip>
