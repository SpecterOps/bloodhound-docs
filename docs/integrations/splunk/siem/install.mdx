...
* BloodHound Enterprise [non-personal API token](/integrations/bloodhound-api/working-with-api#non-personal-api-token) with the **Auditor** role
...
<Steps>
  ...
  <Step title="Configure Splunk app API credentials">
    ...
    <Note>We recommend a [non-personal API token](/integrations/bloodhound-api/working-with-api#non-personal-api-token) with the **Auditor** role for the Splunk integration.</Note>
