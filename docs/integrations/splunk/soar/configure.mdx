...
<Note>
In BloodHound Enterprise v9.0.0 and later, API keys can expire. Plan manual key regeneration in Splunk SOAR before your API key expires. For policy configuration details, see [Configure API key expiration](/manage-bloodhound/auth/api-key-expiration).
</Note>
