...
- BloodHound Enterprise [non-personal API token](/integrations/bloodhound-api/working-with-api#non-personal-api-tokens) with the **Auditor** role
  ...
  <Step title="Navigate to app configuration">
    ...
    <Step title="Configure API credentials">
      ...
      1. Enter the following details:
         ...
         | **Token Key** | The token key from your BloodHound Enterprise non-personal API token |
         | **Token ID** | The token ID from your BloodHound Enterprise non-personal API token |
