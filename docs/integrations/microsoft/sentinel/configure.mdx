...
1. In the Sentinel workspace, navigate to **Configuration** > **Analytics** > **Rule Template**.

   <Frame>
      <img src="/images/integrations/microsoft/sentinel/image35.jpeg" alt="Verify Analytics Rules"/>
   </Frame>

1. You must save **Analytics Rules** to generate incidents. To save, click on any **Analytics Rule** to open a modal on the right-hand side where you will see the **Create Rule** button.
...
1. After you save the workbook, it will appear in the **Active rule tab**.

1. Repeat this process for each **Analytics rule**. Incidents are generated only after the rules are created and saved.

1. To check the incidents after analytics rules are created, navigate to **Investigation & Responses** > **Incidents & Alerts** > **Incidents**.
