...
<Steps>
  ...
  <Step title="Deploy the data connector template">
    ...
    1. Confirm the template opens on the **Custom deployment** page.
       ...
       <Frame>
          <img src="/images/integrations/microsoft/sentinel/image21.png" alt="Customize deployment template"/>
       </Frame>
  </Step>
  ...
  <Step title="Deploy the data connector code">
    ...
    1. Select **Publish files**, select the downloaded `BloodHoundAzureFunction.zip` archive, and click **Save**.
       ...
       <Frame>
          <img src="/images/integrations/microsoft/sentinel/image22.jpeg" alt="Publish files"/>
       </Frame>
