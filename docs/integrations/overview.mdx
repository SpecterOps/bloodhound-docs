...
>
  The BloodHound Enterprise integration for Google SecOps lets you ingest Attack Path findings into Google SecOps as cases, alerts, and events so analysts can investigate and respond without leaving the platform.

  | | |
  | --- | --- |
  | **Supported actions** | <ul><li>Create Google SecOps cases from BloodHound Enterprise Attack Path findings.</li><li>Retrieve asset information from BloodHound Enterprise during an investigation.</li><li>Validate whether a path exists between two assets.</li></ul> |
  | **Common use cases** | <ul><li>Centralize BloodHound Enterprise findings in Google SecOps.</li><li>Group related alerts by source domain for more efficient triage.</li><li>Use playbooks and on-demand actions to enrich investigations.</li></ul> |
