...
>
  The BloodHound Enterprise integration for Google SecOps lets security teams ingest attack path findings into Google SecOps as cases, alerts, and events for investigation and response.

  | | |
  | --- | --- |
  | **Supported actions** | <ul><li>Create cases from BloodHound Enterprise attack path findings.</li><li>Retrieve asset information from BloodHound Enterprise during an investigation.</li><li>Validate whether a path exists between two assets.</li></ul> |
  | **Common use cases** | <ul><li>Centralize BloodHound Enterprise findings in Google SecOps.</li><li>Group related findings by domain for more efficient triage.</li><li>Use playbooks and on-demand actions to enrich investigations.</li></ul> |
