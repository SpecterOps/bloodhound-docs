...
>
  ...
  | | |
  | --- | --- |
  | **Supported actions** | <ul><li>Fetch Attack Path findings from BloodHound Enterprise.</li><li>Create a Microsoft Sentinel incident for each finding.</li><li>Ingest and visualize posture statistics, audit logs, and Tier Zero assets in Microsoft Sentinel dashboards.</li></ul> |
  | **Common use cases** | <ul><li>Automatically convert custom logs based on significant BloodHound Enterprise findings into incidents in Sentinel.</li><li>Enable security analysts to investigate and respond to potential security threats identified by BloodHound Enterprise.</li><li>Use Sentinel Workbooks to visualize and analyze BloodHound data for a clear, actionable view of Attack Paths and potential vulnerabilities in Active Directory.</li></ul> |
