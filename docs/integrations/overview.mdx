...
<Card
  title="Jira"
  href="/integrations/jira/forge/configure"
>
  The BloodHound Enterprise Jira integration is a Jira Cloud app built on Atlassian Forge that automatically syncs BloodHound Enterprise Attack Path findings to Jira issues for remediation tracking. This integration enables security teams to manage and track the remediation of Active Directory and Azure Attack Paths directly within Jira Software and Jira Service Management workflows.
