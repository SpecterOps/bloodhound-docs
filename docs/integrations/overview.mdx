...
>
  Collect Azure and Entra ID via a managed application for use in BloodHound Enterprise

  | | |
  | --- | --- |
  | **Overview** | This is an alternative data collection method to AzureHound. See the <a href="/install-data-collector/install-azurehound/system-requirements">AzureHound system requirements</a> for comparison. |
  | **Supported actions** | This application uses a managed identity versus username/password or certificate-based authentication to collect data from Azure Graph APIs, Azure Resource Manager, and Entra ID. This data is used to map and manage identity attack paths within an Azure tenant through BloodHound Enterprise. |
  | **Access the AzureHound installer** | <a href="https://marketplace.microsoft.com/en-us/product/azurehoundenterprise.specterops-azurehound-managed-application?tab=Overview">AzureHound Managed Application on Microsoft Marketplace</a> |
</Card>
...
>
  ...
  | **Integration instructions** | <a href="https://bloodhound.specterops.io/integrations/cortex-xsoar/configure">Configure the Cortex XSOAR integration</a> |
</Card>
...
>
  ...
  | **Download** | <ul><li>The BloodHound Enterprise Splunk app is published on Splunkbase and can be accessed using the link below.</li><li><a href="https://splunkbase.splunk.com/app/6609">splunkbase.splunk.com/app/6609</a></li></ul> |
  | **Integration instructions** | <a href="https://support.bloodhoundenterprise.io/hc/en-us/articles/11310555936155-Integrate-BloodHound-Enterprise-with-Splunk">Integrate BloodHound Enterprise with Splunk</a> |
</Card>
...
>
  ...
  | **Download** | <ul><li>The BloodHound Enterprise Splunk SOAR app can be accessed using the link below.</li><li><a href="https://github.com/splunk-soar-connectors/specteropsbloodhound">splunk-soar-connectors/specteropsbloodhound</a></li></ul> |
  | **Integration instructions** | <a href="https://support.bloodhoundenterprise.io/hc/en-us/articles/11310555936155-Integrate-BloodHound-Enterprise-with-Splunk">Integrate BloodHound Enterprise with Splunk</a> |
  | **FedRAMP** | Yes |
</Card>
...
>
  ...
  | Download | <ul><li>The BloodHound Enterprise ServiceNow app can be accessed using the link below.</li><li><a href="https://store.servicenow.com/store/app/5400757f1b45a610a85b16db234bcb85#summary">store.servicenow.com/store/app/5400757f1b45a610a85b16db234bcb85</a></li></ul> |
