...
import ServicenowInstall from '/snippets/integrations/servicenow-install.mdx';
import ServicenowCreateUser from '/snippets/integrations/servicenow-create-user.mdx';
...
<ServicenowCreateUser role="x_spop_security_in.app_admin" />
