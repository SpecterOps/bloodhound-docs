...
It collects data about users, groups, applications, roles, and other entities within an Okta organization and represents them as [nodes](/opengraph/extensions/okta/schema#nodes) and [edges](/opengraph/extensions/okta/schema#edges) in BloodHound's graph database.
