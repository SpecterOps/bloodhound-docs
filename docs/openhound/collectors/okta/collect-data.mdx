...
via the `[sources.source.okta.credentials]` section of the secrets file or via environment variables.

### Option 1: Service Application with JSON key file
| Parameter Name | Environment Variable            | Description                                                                        |
|----------------|---------------------------------|------------------------------------------------------------------------------------|
| `base_url`     | SOURCES__OKTA__CREDENTIALS__BASE_URL | The base URL of the Okta organization. For example: `https://spectoropspreview.oktapreview.com`. |
| `client_id`     | SOURCES__OKTA__CREDENTIALS__CLIENT_ID | The client ID of the Okta service application used to authenticate to the Okta API. |
| `private_key_path` | SOURCES__OKTA__CREDENTIALS__PRIVATE_KEY_PATH | The path to the private key (.json) used for authentication. |

### Option 2: Service Application with JSON key string (base64-encoded)
| Parameter Name | Environment Variable            | Description                                                                        |
|----------------|---------------------------------|------------------------------------------------------------------------------------|
| `base_url`     | SOURCES__OKTA__CREDENTIALS__BASE_URL | The base URL of the Okta organization. For example: `https://spectoropspreview.oktapreview.com`. |
| `client_id`     | SOURCES__OKTA__CREDENTIALS__CLIENT_ID | The client ID of the Okta service application used to authenticate to the Okta API. |
| `private_key_encoded` | SOURCES__OKTA__CREDENTIALS__PRIVATE_KEY_ENCODED | The private key (.json) encoded as a base64 string.  |

### Option 3: API Token (SSWS)
| Parameter Name | Environment Variable            | Description                                                                        |
|----------------|---------------------------------|------------------------------------------------------------------------------------|
| `base_url`     | SOURCES__OKTA__CREDENTIALS__BASE_URL | The base URL of the Okta organization. For example: `https://spectoropspreview.oktapreview.com`. |
| `token` | SOURCES__OKTA__CREDENTIALS__TOKEN | The API token (SSWS) used for authentication. |
