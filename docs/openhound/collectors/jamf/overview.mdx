...
It collects data about users, groups, sites, scripts, API integrations, and other entities within a JAMF Pro tenant and represents them as [nodes](/opengraph/extensions/jamf/schema#nodes) and [edges](/opengraph/extensions/jamf/schema#edges) in BloodHound's graph database.
...
<Frame>
  <img src="/images/extensions/jamf/jamf-graph.png" alt="Example JamfHound graph"/>
</Frame>
