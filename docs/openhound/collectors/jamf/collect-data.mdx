...
1. In Jamf Pro, create an [API role](https://learn.jamf.com/en-US/bundle/jamf-pro-documentation-current/page/API_Roles_and_Clients.html) that grants the read privileges required by the collector.
1. Create an API client and assign it the API role from the previous step.
