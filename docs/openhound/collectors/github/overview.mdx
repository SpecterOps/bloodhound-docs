...
It collects data about organizations, users, teams, repositories, branches, roles, secrets, GitHub Apps, and other entities within a GitHub organization and represents them as [nodes](/opengraph/extensions/github/schema#nodes) and [edges](/opengraph/extensions/github/schema#edges) in BloodHound's graph database.
...
<Frame>
  <img src="/images/extensions/github/github_bloodhound.png" alt="Example GitHound graph"/>
</Frame>
