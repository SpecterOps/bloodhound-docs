...
- [Enterprise GitHub App installation](/openhound/collectors/github/configure-enterprise-app): Use this option when you need enterprise-scoped collection (<Badge color="green">recommended</Badge>). To collect enterprise SSO, SCIM, and self-hosted runner data, add a classic PAT from an Enterprise Owner during collector configuration.
...
All options require read-only permissions. See [Configure the Collector](/openhound/collectors/github/collect-data) for the required permission set and runtime configuration.
