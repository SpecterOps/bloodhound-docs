...
- [Enterprise GitHub App installation](/openhound/collectors/github/configure-enterprise-app): Use this option when you need enterprise-scoped collection (<Badge color="green">recommended</Badge>).
