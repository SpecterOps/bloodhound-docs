...
<Tip>
  If you need enterprise-scoped collection for GitHub Enterprise SSO data, use [Configure an Enterprise GitHub App](/openhound/collectors/github/configure-enterprise-app).
</Tip>
