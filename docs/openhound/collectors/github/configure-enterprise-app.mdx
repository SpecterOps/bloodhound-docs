...
<Steps>
  ...
  <Step title="Configure the app settings">
    1. Use the same repository and organization permissions as the [organization GitHub App flow](/openhound/collectors/github/configure-app) with these enterprise-specific notes:
    ...
    1. Set all required [repository and organization permissions](/openhound/collectors/github/collect-data#required-permissions) to **Read-only**.

    1. Set these enterprise permissions to **Read-only**:
...
After creating the enterprise installation, configure the OpenHound GitHub enterprise collector with:
