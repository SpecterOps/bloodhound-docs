...
<Steps>
  ...
  <Step title="Create an OpenHound collector client">
    Register an OpenHound collector [client](/collect-data/enterprise-collection/create-collector) on your BloodHound Enterprise instance to obtain the necessary API token credentials for OpenHound to upload data.
  </Step>
  <Step title="Deploy OpenHound">
    Deploy the OpenHound container and set the necessary parameters in the configuration file or via environment variables. For more information on configuration, visit the generic [configuration](/openhound/configuration) section and the specific configuration page for each collector in the [collectors](/openhound/enterprise#collector-specific-configuration-parameters).
  </Step>
