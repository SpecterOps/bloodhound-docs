...
OpenHound uses DLT's [configuration management](https://dlthub.com/docs/general-usage/credentials/setup) system which allows you to set configuration parameters in configuration files, environment variables, or a combination of both. The following sections provide an overview of commonly used configuration parameters for OpenHound and how to set them up for your deployment. 
Configuring OpenHound works similarly for both the containerized service and the standalone CLI application.
