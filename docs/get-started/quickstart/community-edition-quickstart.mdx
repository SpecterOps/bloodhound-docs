...
* Build the collector from source with the source code for [SharpHound](/collect-data/community/sharphound) or [AzureHound](/collect-data/community/azurehound).
...
For Azure argument definitions, see [All AzureHound Community Edition Flags, Explained](/collect-data/community/azurehound-flags).
