...
* Download the collector from their respective GitHub repository: [SharpHound repository](https://github.com/SpecterOps/SharpHound/releases) or [AzureHound repository](https://github.com/SpecterOps/AzureHound/releases).
