...
<div>
    ...
    <tr>
        <td>
        <img noZoom src="/assets/logo/BHE-logo-square.svg" alt="BloodHound Enterprise logo" />
        </td>
        <td>
        <img noZoom src="/assets/logo/CE-logo-square.svg" alt="BloodHound Community Edition logo" />
        </td>
    </tr>
    <tr>
        <td>
