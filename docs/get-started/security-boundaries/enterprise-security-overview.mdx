...
For SharpHound, see [SharpHound Data Collection and Permissions](/collect-data/sharphound-data-permissions).

For AzureHound, see [AzureHound Data and Permissions](/collect-data/azurehound-data-permissions).
