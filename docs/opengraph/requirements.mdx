...
description: "Requirements for use of OpenGraph"
---
...
We recommend utilizing PascalCase, a naming convention where compound words are written without spaces and each word starts with an uppercase letter (e.g., `MemberOf`, `GenericAll`).
