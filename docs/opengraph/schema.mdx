...
This page explains the JSON format BloodHound ingests to display OpenGraph nodes and edges.

Terms used on this page:

- **Schema-less (generic) data** refers to OpenGraph payloads that follow the minimum node and edge JSON format.
- **Schema-based data** refers to OpenGraph payloads that follow an extension-defined schema (separate from the payload).
