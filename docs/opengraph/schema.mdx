...
The following is an example that you can use as a starting point to build your own OpenGraph. Copy and paste the following sample into a new `.json` file or <a href="/assets/opengraph/opengraph-node.json" download>download this sample file</a>.
...
The following is an example that you can use as a starting point to build your own OpenGraph. Copy and paste the following sample into a new `.json` file or <a href="/assets/opengraph/opengraph-edge.json" download>download this sample file</a>.
...
The following is an example that you can use as a starting point to build your own OpenGraph. Copy and paste the following sample into a new `.json` file or <a href="/assets/opengraph/opengraph-minimal.json" download>download this sample file</a>.
