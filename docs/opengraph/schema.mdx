...
The following is the JSON schema that all nodes must conform to. It includes example payloads that demonstrate valid node structures.
...
The following is the JSON schema that all edges must conform to. It includes example payloads that demonstrate valid edge structures.
