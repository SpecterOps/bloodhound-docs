...
The following is an example that you can use as a starting point to build your own OpenGraph. Copy and paste the following sample into a new `.json` file or download this <a href="/download/opengraph-node.json" download>sample file</a>.
...
The following is an example that you can use as a starting point to build your own OpenGraph. Copy and paste the following sample into a new `.json` file or download this <a href="/download/opengraph-edge.json" download>sample file</a>.
...
The following is an example that you can use as a starting point to build your own OpenGraph. Copy and paste the following sample into a new `.json` file or download this <a href="/download/opengraph-minimal.json" download>sample file</a>.
