...
The following is the most simple JSON file we could come up with. You can use it as a starting point to build your own Open Graph. Copy and paste the following sample into a new `.json` file or download this [sample file](../../download/opengraph-minimal.json).
