...
The following is an example that you can use as a starting point to build your own OpenGraph. Copy and paste the following sample into a new `.json` file or [download this sample file](/assets/opengraph/opengraph-node.json).
