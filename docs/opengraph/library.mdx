...
A Python library for creating BloodHound OpenGraph JSON data that conforms to the BloodHound OpenGraph [data payload schema](/opengraph/developer/data-overview).
