...
AnsibleHound is a BloodHound OpenGraph collector for Ansible WorX and [Ansible Tower](https://docs.ansible.com/ansible-tower/). The collector is designed to map the structure and permissions of your organization into a navigable attack-path graph.
...
<Accordion title="SCCM" icon="people-group">
...
**Authors/Maintainers**
- [Matluck](https://github.com/matcluck-cs) @[CrowdStrike](https://www.crowdstrike.com)
