...
* PowerShell
* A [Personal Access Token](/opengraph/extensions/githound/configure-pat) or [GitHub App Installation](/opengraph/extensions/githound/configure-app) configured with the required permissions
