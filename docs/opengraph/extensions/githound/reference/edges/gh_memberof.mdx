...
- Source: [GH_TeamRole](/opengraph/extensions/githound/reference/nodes/gh_teamrole), [GH_Team](/opengraph/extensions/githound/reference/nodes/gh_team)
- Destination: [GH_Team](/opengraph/extensions/githound/reference/nodes/gh_team)
- Traversable: ✅
