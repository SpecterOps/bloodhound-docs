...
- Source: [GH_App](/opengraph/extensions/githound/reference/nodes/gh_app)
- Destination: [GH_AppInstallation](/opengraph/extensions/githound/reference/nodes/gh_appinstallation)
- Traversable: ✅
