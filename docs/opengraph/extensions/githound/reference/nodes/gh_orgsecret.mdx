...
| [GH_HasSecret](/opengraph/extensions/githound/reference/edges/gh_hassecret) | [GH_Repository](/opengraph/extensions/githound/reference/nodes/gh_repository), [GH_Environment](/opengraph/extensions/githound/reference/nodes/gh_environment) | ✅ |
...
| --------------------------------------------------- | ------------------------------------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [GH_Contains](/opengraph/extensions/githound/reference/edges/gh_contains)   | [GH_Organization](/opengraph/extensions/githound/reference/nodes/gh_organization) | No          | Organization contains this secret.                                                                                                                                                                                             |
| [GH_HasSecret](/opengraph/extensions/githound/reference/edges/gh_hassecret) | [GH_Repository](/opengraph/extensions/githound/reference/nodes/gh_repository)     | Yes         | Repository has access to this organization secret (resolved by visibility). Traversable because any user with write access to the repository can access org secrets scoped to that repo by creating a GitHub Actions workflow. |
