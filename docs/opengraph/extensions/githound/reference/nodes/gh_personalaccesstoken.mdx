...
| [GH_HasPersonalAccessToken](/opengraph/extensions/githound/reference/edges/gh_haspersonalaccesstoken) | [GH_User](/opengraph/extensions/githound/reference/nodes/gh_user) | ❌ | User owns this personal access token that has been granted access to the organization |
