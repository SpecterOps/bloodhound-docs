...
| --------------------------------------------------- | --------------------------------- | ----------- | --------------------------------- |
| [GH_CanAccess](../edgedescriptions/gh_canaccess) | [GH_Repository](/opengraph/extensions/githound/reference/nodes/gh_repository) | No          | Token can access this repository. |

### Inbound Edges

| Edge Kind                                                                     | Source Node                           | Traversable | Description                                       |
| ----------------------------------------------------------------------------- | ------------------------------------- | ----------- | ------------------------------------------------- |
| [GH_HasPersonalAccessToken](../edgedescriptions/gh_haspersonalaccesstoken) | [GH_User](/opengraph/extensions/githound/reference/nodes/gh_user)                 | No          | User owns this personal access token.             |
| [GH_Contains](../edgedescriptions/gh_contains)                             | [GH_Organization](/opengraph/extensions/githound/reference/nodes/gh_organization) | No          | Organization contains this personal access token. |
