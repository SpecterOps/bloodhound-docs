...
| --------- | ----------------- | ----------- |
| [GH_HasWorkflow](/opengraph/extensions/githound/reference/edges/gh_hasworkflow) | [GH_Repository](/opengraph/extensions/githound/reference/nodes/gh_repository) | ❌ |
...
| ------------------------------------------------------- | --------------------------------- | ----------- | ----------------------------- |
| [GH_HasWorkflow](/opengraph/extensions/githound/reference/edges/gh_hasworkflow) | [GH_Repository](/opengraph/extensions/githound/reference/nodes/gh_repository) | No          | Repository has this workflow. |
