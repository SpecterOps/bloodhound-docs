...
| [GH_HasSecret](/opengraph/extensions/githound/reference/edges/gh_hassecret) | [GH_Repository](/opengraph/extensions/githound/reference/nodes/gh_repository), [GH_Environment](/opengraph/extensions/githound/reference/nodes/gh_environment) | ✅ | Repository or environment has access to this secret |
