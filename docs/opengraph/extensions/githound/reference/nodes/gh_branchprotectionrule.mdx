...
| --------- | ----------------- | ----------- | ----------- |
| [GH_BypassPullRequestAllowances](/opengraph/extensions/githound/reference/edges/gh_bypasspullrequestallowances) | [GH_User](/opengraph/extensions/githound/reference/nodes/gh_user), [GH_Team](/opengraph/extensions/githound/reference/nodes/gh_team) | ❌ | User or team can bypass pull request requirements on a branch protection rule |
| [GH_RestrictionsCanPush](/opengraph/extensions/githound/reference/edges/gh_restrictionscanpush) | [GH_User](/opengraph/extensions/githound/reference/nodes/gh_user), [GH_Team](/opengraph/extensions/githound/reference/nodes/gh_team) | ❌ | User or team is allowed to push to branches protected by this rule |

### Outbound Edges

| Edge Type | Destination Node Types | Traversable | Description |
| --------- | ---------------------- | ----------- | ----------- |
| [GH_ProtectedBy](/opengraph/extensions/githound/reference/edges/gh_protectedby) | [GH_Branch](/opengraph/extensions/githound/reference/nodes/gh_branch) | ❌ | Branch protection rule protects this branch |
