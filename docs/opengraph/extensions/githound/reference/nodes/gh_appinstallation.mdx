...
| [GH_InstalledAs](/opengraph/extensions/githound/reference/edges/gh_installedas) | [GH_App](/opengraph/extensions/githound/reference/nodes/gh_app) | ✅ | GitHub App is installed as this app installation on an organization |

### Outbound Edges

| Edge Type | Destination Node Types | Traversable | Description |
| --------- | ---------------------- | ----------- | ----------- |
| [GH_CanAccess](/opengraph/extensions/githound/reference/edges/gh_canaccess) | [GH_Repository](/opengraph/extensions/githound/reference/nodes/gh_repository) | ❌ | Personal access token or app installation can access this repository or organization |
