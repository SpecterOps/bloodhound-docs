...
| --------- | ----------------- | ----------- | ----------- |
| [GH_HasSamlIdentityProvider](/opengraph/extensions/githound/reference/edges/gh_hassamlidentityprovider) | [GH_Organization](/opengraph/extensions/githound/reference/nodes/gh_organization) | ❌ | Organization has this SAML identity provider configured |

### Outbound Edges

| Edge Type | Destination Node Types | Traversable | Description |
| --------- | ---------------------- | ----------- | ----------- |
| [GH_HasExternalIdentity](/opengraph/extensions/githound/reference/edges/gh_hasexternalidentity) | [GH_ExternalIdentity](/opengraph/extensions/githound/reference/nodes/gh_externalidentity) | ❌ | SAML identity provider has this external identity |
