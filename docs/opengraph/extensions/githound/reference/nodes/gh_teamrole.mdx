...
| --------------------------------------------------- | --------------------- | ----------- | -------------------------------------------------------------- |
| [GH_MemberOf](../edgedescriptions/gh_memberof)   | [GH_Team](/opengraph/extensions/githound/reference/nodes/gh_team) | Yes         | This role belongs to a team.                                   |
| [GH_AddMember](../edgedescriptions/gh_addmember) | [GH_Team](/opengraph/extensions/githound/reference/nodes/gh_team) | Yes         | Maintainer role can add members to the team (Maintainer only). |

### Inbound Edges

| Edge Kind                                       | Source Node           | Traversable | Description                           |
| ----------------------------------------------- | --------------------- | ----------- | ------------------------------------- |
| [GH_HasRole](../edgedescriptions/gh_hasrole) | [GH_User](/opengraph/extensions/githound/reference/nodes/gh_user) | Yes         | A user is assigned to this team role. |
