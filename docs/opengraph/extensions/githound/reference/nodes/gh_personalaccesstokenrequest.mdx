...
| ------------------------------------------------------------------------------------------- | ------------------------------------- | ----------- | --------------------------------------------------------- |
| [GH_HasPersonalAccessTokenRequest](../edgedescriptions/gh_haspersonalaccesstokenrequest) | [GH_User](/opengraph/extensions/githound/reference/nodes/gh_user)                 | No          | User submitted this personal access token request.        |
| [GH_Contains](../edgedescriptions/gh_contains)                                           | [GH_Organization](/opengraph/extensions/githound/reference/nodes/gh_organization) | No          | Organization contains this personal access token request. |
