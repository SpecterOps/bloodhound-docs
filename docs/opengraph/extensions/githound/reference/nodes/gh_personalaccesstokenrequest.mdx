...
| [GH_HasPersonalAccessTokenRequest](/opengraph/extensions/githound/reference/edges/gh_haspersonalaccesstokenrequest) | [GH_User](/opengraph/extensions/githound/reference/nodes/gh_user) | ❌ | User has a pending personal access token request for the organization |
