...
| --------- | ---------------------- | ----------- | ----------- |
| [GH_ValidToken](/opengraph/extensions/githound/reference/edges/gh_validtoken) | [GH_User](/opengraph/extensions/githound/reference/nodes/gh_user) | ✅ | Secret scanning alert contains a valid, active token belonging to this user |
