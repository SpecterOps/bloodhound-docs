...
| ----------------------------------------------------- | --------------------- | ----------- | ----------------------------------------------------------------------------------- |
| [GH_MapsToUser](/opengraph/extensions/githound/reference/edges/gh_mapstouser) | [GH_User](/opengraph/extensions/githound/reference/nodes/gh_user) | No          | External identity maps to a GitHub user (via GitHub user ID).                       |
| [GH_MapsToUser](/opengraph/extensions/githound/reference/edges/gh_mapstouser) | Foreign User Node     | No          | External identity maps to a user in a foreign environment (via SAML/SCIM username). |

### Inbound Edges

| Edge Kind                                                               | Source Node                                           | Traversable | Description                                        |
| ----------------------------------------------------------------------- | ----------------------------------------------------- | ----------- | -------------------------------------------------- |
| [GH_HasExternalIdentity](/opengraph/extensions/githound/reference/edges/gh_hasexternalidentity) | [GH_SamlIdentityProvider](/opengraph/extensions/githound/reference/nodes/gh_samlidentityprovider) | No          | SAML identity provider has this external identity. |
