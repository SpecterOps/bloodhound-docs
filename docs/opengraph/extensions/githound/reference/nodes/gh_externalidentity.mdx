...
| --------- | ----------------- | ----------- | ----------- |
| [GH_HasExternalIdentity](/opengraph/extensions/githound/reference/edges/gh_hasexternalidentity) | [GH_SamlIdentityProvider](/opengraph/extensions/githound/reference/nodes/gh_samlidentityprovider) | ❌ | SAML identity provider has this external identity |

### Outbound Edges

| Edge Type | Destination Node Types | Traversable | Description |
| --------- | ---------------------- | ----------- | ----------- |
| [GH_MapsToUser](/opengraph/extensions/githound/reference/edges/gh_mapstouser) | [GH_User](/opengraph/extensions/githound/reference/nodes/gh_user) | ❌ | External identity maps to a GitHub user or identity provider user |
