...
| --------- | ----------------- | ----------- | ----------- |
| [GH_HasEnvironment](/opengraph/extensions/githound/reference/edges/gh_hasenvironment) | [GH_Repository](/opengraph/extensions/githound/reference/nodes/gh_repository), [GH_Branch](/opengraph/extensions/githound/reference/nodes/gh_branch) | ❌ | Repository or branch has/can deploy to this environment |
