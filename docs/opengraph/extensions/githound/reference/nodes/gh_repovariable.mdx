...
| --------- | ----------------- | ----------- | ----------- |
| [GH_HasVariable](/opengraph/extensions/githound/reference/edges/gh_hasvariable) | [GH_Repository](/opengraph/extensions/githound/reference/nodes/gh_repository) | ✅ | Repository has access to this variable (org-level or repo-level) |
