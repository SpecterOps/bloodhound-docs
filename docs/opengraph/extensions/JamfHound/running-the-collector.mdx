...
`python3 main.py --username administrator1 --password $admin_pass_var --target https://mytenant.jamfcloud.com --collect `

## Installing JamfHound
...
## Running JamfHound With Okta Edges
...
JamfHound will create a local collection directory named with a timestamp for when it was run. (example Collection_2026_03_02_16_02_48)

Within that directory will be the ouptut file JAMFCollection.json that will be uploaded and ingested into BloodHound.
