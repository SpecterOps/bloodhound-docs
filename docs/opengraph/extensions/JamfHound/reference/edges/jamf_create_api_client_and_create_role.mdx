...
```mermaid
graph LR
    A["jamf_Account\ndev.ops"] -->|jamf_Create_API_Client_and_Create_Role| B["jamf_Tenant\nCorpJamfPro"]
    C["jamf_Group\nAPI-Managers"] -->|jamf_Create_API_Client_and_Create_Role| B
    D["jamf_ApiClient\nplatform-client"] -->|jamf_Create_API_Client_and_Create_Role| B
```
