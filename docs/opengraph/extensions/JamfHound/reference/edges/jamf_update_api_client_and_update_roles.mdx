...
```mermaid
graph LR
    A["jamf_Account\napi.manager"] -->|jamf_Update_API_Client_and_Update_Roles| B["jamf_Tenant\nCorpJamfPro"]
    C["jamf_Group\nAPI-Governance"] -->|jamf_Update_API_Client_and_Update_Roles| B
    D["jamf_DisabledAccount\nformer.devops"] -->|jamf_Update_API_Client_and_Update_Roles| B
```
