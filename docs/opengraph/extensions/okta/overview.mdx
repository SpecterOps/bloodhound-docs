...
- [OpenHound Okta collector](/openhound/collectors/oktahound/overview): The SpecterOps-supported Okta collector. This is the primary documented path for collecting Okta data for BloodHound.
