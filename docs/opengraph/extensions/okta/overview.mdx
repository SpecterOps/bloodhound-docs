...
In BloodHound Enterprise v9.3.0 and later, the official SpecterOps-supported Okta extension schema is pre-installed in the product. Use [OpenGraph Extension Management](/opengraph/extensions/manage) to verify the installed version or upload a newer supported schema manually.
