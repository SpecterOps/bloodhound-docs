...
In BloodHound Enterprise v9.3.0 and later, Okta is supported as a built-in extension. Use [OpenGraph Extension Management](/opengraph/extensions/manage) to verify the installed version or upload a newer supported schema manually.
