...
| --------- | ----------------- | ----------- |
| [Okta_AgentMemberOf](/opengraph/extensions/okta/edges/okta_agentmemberof) | [Okta_Agent](/opengraph/extensions/okta/nodes/okta_agent) | ✅ |
...
| --------- | ---------------------- | ----------- |
| [Okta_AgentPoolFor](/opengraph/extensions/okta/edges/okta_agentpoolfor) | [Okta_Application](/opengraph/extensions/okta/nodes/okta_application) | ✅ |
