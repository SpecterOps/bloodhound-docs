...
| --------- | ----------------- | ----------- |
| [Okta_HostsAgent](/opengraph/extensions/okta/edges/okta_hostsagent) | [Computer](/resources/nodes/computer) | ✅ |

### Outbound Edges

| Edge Type | Destination Node Types | Traversable |
| --------- | ---------------------- | ----------- |
| [Okta_AgentMemberOf](/opengraph/extensions/okta/edges/okta_agentmemberof) | [Okta_AgentPool](/opengraph/extensions/okta/nodes/okta_agentpool) | ✅ |
