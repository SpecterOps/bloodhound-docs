...
- Source: [User](/resources/nodes/user), [Okta_User](/opengraph/extensions/okta/nodes/okta_user)
- Destination: [Okta_User](/opengraph/extensions/okta/nodes/okta_user), [User](/resources/nodes/user)
- Traversable: ✅
