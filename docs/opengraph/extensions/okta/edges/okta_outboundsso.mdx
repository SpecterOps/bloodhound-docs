...
- Destination: [AZUser](/resources/nodes/az-user), [GH_User](https://github.com/SpecterOps/GitHound), [jamf_Account](https://github.com/SpecterOps/JamfHound), [SNOW_User](https://github.com/SpecterOps/SnowHound), [Okta_User](/opengraph/extensions/oktahound/reference/nodes/okta_user)
- Traversable: ✅
