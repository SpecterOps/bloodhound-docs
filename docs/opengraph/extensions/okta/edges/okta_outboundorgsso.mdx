...
- Destination: [AZTenant](/resources/nodes/az-tenant), [GH_Organization](/opengraph/extensions/github/nodes/gh_organization), [jamf_SSOIntegration](/opengraph/extensions/jamf/nodes/jamf_ssointegration), [SNOW_Account](https://github.com/SpecterOps/SnowHound), [Okta_IdentityProvider](/opengraph/extensions/okta/nodes/okta_identityprovider)
- Traversable: ✅
