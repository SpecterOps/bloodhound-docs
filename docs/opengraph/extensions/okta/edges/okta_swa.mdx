...
- Source: [Okta_User](/opengraph/extensions/okta/nodes/okta_user)
- Destination: [GH_User](/opengraph/extensions/github/nodes/gh_user), [jamf_Account](/opengraph/extensions/jamf/nodes/jamf_account), [OP_User](https://github.com/SpecterOps/1PassHound), [SNOW_User](https://github.com/SpecterOps/SnowHound)
- Traversable: ❌
