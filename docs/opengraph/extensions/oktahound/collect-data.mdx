...
Register OktaHound as a service application in Okta.
...
<Card title="Okta App Registration" icon="gear" href="/opengraph/extensions/oktahound/okta-app-registration" horizontal/>
...
Download the latest release of OktaHound specific to your operating system from the [releases page](https://github.com/SpecterOps/OktaHound/releases) on GitHub and extract the archive.
