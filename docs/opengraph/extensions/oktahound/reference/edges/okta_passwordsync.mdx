...
- Source: [User](/resources/nodes/user), [Okta_User](/opengraph/extensions/oktahound/reference/nodes/okta_user)
- Destination: [Okta_User](/opengraph/extensions/oktahound/reference/nodes/okta_user), [User](/resources/nodes/user)
- Traversable: ✅
