...
- Source: [Okta_User](../nodes/okta_user), [Okta_Application](../nodes/okta_application), [Okta_ApiServiceIntegration](../nodes/okta_apiserviceintegration)
- Destination: [Okta_ApiServiceIntegration](../nodes/okta_apiserviceintegration)
- Traversable: ❌
