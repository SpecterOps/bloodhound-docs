...
- Source: [Okta_JWK](/opengraph/extensions/oktahound/reference/nodes/okta_jwk)
- Destination: [Okta_Application](/opengraph/extensions/oktahound/reference/nodes/okta_application)
- Traversable: ✅

## General Information

The traversable `Okta_KeyOf` edges represent the relationships between applications ([Okta_Application](../nodes/okta_application)) and their JWKs:
