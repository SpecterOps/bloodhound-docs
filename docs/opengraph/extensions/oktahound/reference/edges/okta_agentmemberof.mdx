...
- Source: [Okta_Agent](/opengraph/extensions/oktahound/reference/nodes/okta_agent)
- Destination: [Okta_AgentPool](/opengraph/extensions/oktahound/reference/nodes/okta_agentpool)
- Traversable: ✅
