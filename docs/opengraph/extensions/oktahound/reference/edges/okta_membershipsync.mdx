...
- Source: [Okta_Group](/opengraph/extensions/oktahound/reference/nodes/okta_group), [Group](https://bloodhound.specterops.io/resources/nodes/group), [AZGroup](https://bloodhound.specterops.io/resources/nodes/az-group)
- Destination: [Okta_Group](/opengraph/extensions/oktahound/reference/nodes/okta_group), [Group](https://bloodhound.specterops.io/resources/nodes/group), [AZGroup](https://bloodhound.specterops.io/resources/nodes/az-group)
- Traversable: ✅
