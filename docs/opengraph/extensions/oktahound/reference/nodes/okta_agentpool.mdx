...
The `Okta_AgentPool` nodes represent Okta Agent Pools, which are collections of Okta Agents (represented as [Okta_Agent](/opengraph/extensions/oktahound/reference/nodes/okta_agent) nodes) that work together to provide high availability and load balancing for on-premises integrations.
...
![Okta AD Agent Pools displayed in BloodHound](/images/extensions/oktahound/reference/bloodhound-ad-agent-pool.png)
...
| --------- | ----------------- | ----------- | ----------- |
| [Okta_AgentMemberOf](/opengraph/extensions/oktahound/reference/edges/okta_agentmemberof) | [Okta_Agent](/opengraph/extensions/oktahound/reference/nodes/okta_agent) | ✅ | Membership of an Okta agent in an agent pool |
...
| --------- | ---------------------- | ----------- | ----------- |
| [Okta_AgentPoolFor](/opengraph/extensions/oktahound/reference/edges/okta_agentpoolfor) | [Okta_Application](/opengraph/extensions/oktahound/reference/nodes/okta_application) | ✅ | Relationship between an AD agent pool and its backing AD application |
