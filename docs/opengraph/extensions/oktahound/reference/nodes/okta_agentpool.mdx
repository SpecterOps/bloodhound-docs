...
| --------- | ----------------- |
| [Okta_AgentMemberOf](/opengraph/extensions/oktahound/reference/edges/okta_agentmemberof) | [Okta_Agent](/opengraph/extensions/oktahound/reference/nodes/okta_agent) |
...
| --------- | ---------------------- |
| [Okta_AgentPoolFor](/opengraph/extensions/oktahound/reference/edges/okta_agentpoolfor) | [Okta_Application](/opengraph/extensions/oktahound/reference/nodes/okta_application) |
