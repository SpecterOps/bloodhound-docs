...
| [Okta_InboundOrgSSO](/opengraph/extensions/oktahound/reference/edges/okta_inboundorgsso) | [AZTenant](https://bloodhound.specterops.io/resources/nodes/az-tenant) |
| [Okta_OutboundOrgSSO](/opengraph/extensions/oktahound/reference/edges/okta_outboundorgsso) | [Okta_Application](/opengraph/extensions/oktahound/reference/nodes/okta_application) |
...
| --------- | ---------------------- |
| [Okta_IdentityProviderFor](/opengraph/extensions/oktahound/reference/edges/okta_identityproviderfor) | [Okta_User](/opengraph/extensions/oktahound/reference/nodes/okta_user) |
| [Okta_IdpGroupAssignment](/opengraph/extensions/oktahound/reference/edges/okta_idpgroupassignment) | [Okta_Group](/opengraph/extensions/oktahound/reference/nodes/okta_group) |
