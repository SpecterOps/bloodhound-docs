...
| --------- | ---------------------- |
| [Okta_PolicyMapping](/opengraph/extensions/oktahound/reference/edges/okta_policymapping) | [Okta_Application](/opengraph/extensions/oktahound/reference/nodes/okta_application) |
