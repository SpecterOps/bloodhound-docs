...
| --------- | ----------------- |
| [Okta_HostsAgent](/opengraph/extensions/oktahound/reference/edges/okta_hostsagent) | [Computer](https://bloodhound.specterops.io/resources/nodes/computer) |

### Outbound Edges

| Edge Type | Destination Node Types |
| --------- | ---------------------- |
| [Okta_AgentMemberOf](/opengraph/extensions/oktahound/reference/edges/okta_agentmemberof) | [Okta_AgentPool](/opengraph/extensions/oktahound/reference/nodes/okta_agentpool) |
