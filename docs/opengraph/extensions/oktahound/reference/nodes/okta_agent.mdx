...
One or more agents are grouped into Agent Pools, represented by the [Okta_AgentPool](/opengraph/extensions/oktahound/reference/nodes/okta_agentpool) nodes, to provide redundancy and load balancing.

![Active Directory Agent in BloodHound](/images/extensions/oktahound/reference/bloodhound-ad-agent.png)
...
| --------- | ----------------- | ----------- | ----------- |
| [Okta_HostsAgent](/opengraph/extensions/oktahound/reference/edges/okta_hostsagent) | [Computer](https://bloodhound.specterops.io/resources/nodes/computer) | ✅ | Relationship between an AD server and the Okta agent running on that host |

### Outbound Edges

| Edge Type | Destination Node Types | Traversable | Description |
| --------- | ---------------------- | ----------- | ----------- |
| [Okta_AgentMemberOf](/opengraph/extensions/oktahound/reference/edges/okta_agentmemberof) | [Okta_AgentPool](/opengraph/extensions/oktahound/reference/nodes/okta_agentpool) | ✅ | Membership of an Okta agent in an agent pool |
...
| `poolName` | `agentPool.name` | `string` | Name of the parent [Okta_AgentPool](/opengraph/extensions/oktahound/reference/nodes/okta_agentpool). For AD pools this typically corresponds to the synced AD domain. |
