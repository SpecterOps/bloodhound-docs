...
| --------- | ----------------- | ----------- | ----------- |
| [Okta_AgentPoolFor](/opengraph/extensions/oktahound/reference/edges/okta_agentpoolfor) | [Okta_AgentPool](/opengraph/extensions/oktahound/reference/nodes/okta_agentpool) | ✅ | Relationship between an AD agent pool and its backing AD application |
| [Okta_AppAdmin](/opengraph/extensions/oktahound/reference/edges/okta_appadmin) | [Okta_User](/opengraph/extensions/oktahound/reference/nodes/okta_user), [Okta_Group](/opengraph/extensions/oktahound/reference/nodes/okta_group), [Okta_Application](/opengraph/extensions/oktahound/reference/nodes/okta_application) | ✅ | Application administrator role assignment |
| [Okta_AppAssignment](/opengraph/extensions/oktahound/reference/edges/okta_appassignment) | [Okta_User](/opengraph/extensions/oktahound/reference/nodes/okta_user), [Okta_Group](/opengraph/extensions/oktahound/reference/nodes/okta_group) | ❌ | Assignment of users or groups to an Okta application |
...
| [Okta_GroupPush](/opengraph/extensions/oktahound/reference/edges/okta_grouppush) | [Okta_Group](/opengraph/extensions/oktahound/reference/nodes/okta_group) | ❌ | Provisioning of group memberships to an external application |
| [Okta_KerberosSSO](/opengraph/extensions/oktahound/reference/edges/okta_kerberossso) | [User](https://bloodhound.specterops.io/resources/nodes/user) | ✅ | Agentless desktop SSO relationship from on-prem AD user account to Okta AD application |
| [Okta_KeyOf](/opengraph/extensions/oktahound/reference/edges/okta_keyof) | [Okta_JWK](/opengraph/extensions/oktahound/reference/nodes/okta_jwk) | ✅ | JSON Web Key associated with an Okta application |
| [Okta_ManageApp](/opengraph/extensions/oktahound/reference/edges/okta_manageapp) | [Okta_User](/opengraph/extensions/oktahound/reference/nodes/okta_user), [Okta_Group](/opengraph/extensions/oktahound/reference/nodes/okta_group), [Okta_Application](/opengraph/extensions/oktahound/reference/nodes/okta_application) | ✅ | Ability to manage scoped Okta applications |
| [Okta_PolicyMapping](/opengraph/extensions/oktahound/reference/edges/okta_policymapping) | [Okta_Policy](/opengraph/extensions/oktahound/reference/nodes/okta_policy) | ❌ | Association of a policy with an Okta application |
...
| [Okta_SecretOf](/opengraph/extensions/oktahound/reference/edges/okta_secretof) | [Okta_ClientSecret](/opengraph/extensions/oktahound/reference/nodes/okta_clientsecret) | ✅ | Client secret associated with an application or service integration |
| [Okta_UserPush](/opengraph/extensions/oktahound/reference/edges/okta_userpush) | [Okta_User](/opengraph/extensions/oktahound/reference/nodes/okta_user) | ❌ | Provisioning of users to an external application |
...
| [Okta_GroupPull](/opengraph/extensions/oktahound/reference/edges/okta_grouppull) | [Okta_Group](/opengraph/extensions/oktahound/reference/nodes/okta_group) | ✅ | Import of group memberships from an external application |
...
| [Okta_ReadPasswordUpdates](/opengraph/extensions/oktahound/reference/edges/okta_readpasswordupdates) | [Okta_User](/opengraph/extensions/oktahound/reference/nodes/okta_user) | ✅ | Application can read password updates over the SCIM protocol |
...
| [Okta_UserPull](/opengraph/extensions/oktahound/reference/edges/okta_userpull) | [Okta_User](/opengraph/extensions/oktahound/reference/nodes/okta_user) | ❌ | Import of users from an external application |
...
![Okta Application scopes and roles in BloodHound](/images/extensions/oktahound/reference/bloodhound-app-scopes.png)
...
![Okta AD agent settings](/images/extensions/oktahound/reference/okta-ad-agent.png)
...
![Properties of the GitHub Application node](/images/extensions/oktahound/reference/bloodhound-github-properties.png)
...
![Jamf Pro SAML application in BloodHound](/images/extensions/oktahound/reference/bloodhound-jamf-saml-properties.png)

It is also possible to integrate Jamf Pro with Okta using Secure Web Authentication (SWA), but this option is less secure.

![Jamf Pro SWA settings](/images/extensions/oktahound/reference/app-jamf-swa.png)
...
![Google Workspace SAML application in BloodHound](/images/extensions/oktahound/reference/bloodhound-google-saml-properties.png)

The SAML 2.0 protocol should always be preferred to SWA when integrating Okta with Google Workspace:

![Google Workspace sign-in protocol settings](/images/extensions/oktahound/reference/app-google-protocol-selector.png)
...
![Okta SAML application in BloodHound](/images/extensions/oktahound/reference/bloodhound-app-saml.png)
...
![Okta SWA application in BloodHound](/images/extensions/oktahound/reference/bloodhound-app-swa.png)
...
![Okta application OIDC grants](/images/extensions/oktahound/reference/app-oidc-grants.png)
