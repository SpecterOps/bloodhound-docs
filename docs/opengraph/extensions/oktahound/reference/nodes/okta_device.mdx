...
| [Okta_MobileAdmin](/opengraph/extensions/oktahound/reference/edges/okta_mobileadmin) | [Okta_User](/opengraph/extensions/oktahound/reference/nodes/okta_user), [Okta_Group](/opengraph/extensions/oktahound/reference/nodes/okta_group), [Okta_Application](/opengraph/extensions/oktahound/reference/nodes/okta_application) | ✅ | Mobile administrator role assignment |
...
| --------- | ---------------------- | ----------- | ----------- |
| [Okta_DeviceOf](/opengraph/extensions/oktahound/reference/edges/okta_deviceof) | [Okta_User](/opengraph/extensions/oktahound/reference/nodes/okta_user) | ❌ | Ownership relationship between a device and its assigned user |
