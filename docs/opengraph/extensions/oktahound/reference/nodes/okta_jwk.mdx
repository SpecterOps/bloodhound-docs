...
| --------- | ---------------------- | ----------- | ----------- |
| [Okta_KeyOf](/opengraph/extensions/oktahound/reference/edges/okta_keyof) | [Okta_Application](/opengraph/extensions/oktahound/reference/nodes/okta_application) | ✅ | JSON Web Key associated with an Okta application |
