...
| --------- | ---------------------- |
| [Okta_SecretOf](/opengraph/extensions/oktahound/reference/edges/okta_secretof) | [Okta_Application](/opengraph/extensions/oktahound/reference/nodes/okta_application), [Okta_ApiServiceIntegration](/opengraph/extensions/oktahound/reference/nodes/okta_apiserviceintegration) |
