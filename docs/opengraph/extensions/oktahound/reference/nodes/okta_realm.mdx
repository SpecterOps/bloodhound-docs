...
| --------- | ---------------------- | ----------- | ----------- |
| [Okta_RealmContains](/opengraph/extensions/oktahound/reference/edges/okta_realmcontains) | [Okta_User](/opengraph/extensions/oktahound/reference/nodes/okta_user) | ✅ | Contains relationship between an Okta realm and its users |
