...
It collects data about users, groups, applications, roles, and other entities within an Okta organization and represents them as [nodes](reference/schema#nodes) and [edges](reference/schema#Edges) in BloodHound's graph database.
...
<Card title="Getting Started" icon="rocket" href="/opengraph/extensions/oktahound/getting-started" horizontal>
