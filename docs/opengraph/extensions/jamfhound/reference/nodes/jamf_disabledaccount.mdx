...
> This node shares its property set with [jamf_Account](/opengraph/extensions/jamfhound/reference/nodes/jamf_account). The difference is that the account's `enabled` property is set to "Disabled".
