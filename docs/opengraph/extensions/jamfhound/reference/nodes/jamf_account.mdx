...
| [jamf_MatchedEmail](/opengraph/extensions/jamfhound/reference/edges/jamf_matchedemail) | [jamf_ComputerUser](/opengraph/extensions/jamfhound/reference/nodes/jamf_computeruser) | ✅ | Represents an identity correlation where the JAMF computer user's email attribute matches the JAMF account's email. |
| [jamf_MatchedName](/opengraph/extensions/jamfhound/reference/edges/jamf_matchedname) | [jamf_ComputerUser](/opengraph/extensions/jamfhound/reference/nodes/jamf_computeruser) | ✅ | Represents an identity correlation where the JAMF computer user's displayname matches the JAMF account's name or displayname. |
...
| --------- | ---------------------- | ----------- | ----------- |
| [jamf_AdminTo](/opengraph/extensions/jamfhound/reference/edges/jamf_adminto) | [jamf_Tenant](/opengraph/extensions/jamfhound/reference/nodes/jamf_tenant) | ✅ | Represents full administrative control over the target and all resources controlled by the target. |
...
| [jamf_MemberOf](/opengraph/extensions/jamfhound/reference/edges/jamf_memberof) | [jamf_Group](/opengraph/extensions/jamfhound/reference/nodes/jamf_group) | ✅ | Represents group membership where the source inherits the group's permissions and assignments. |
