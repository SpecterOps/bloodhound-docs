...
The non-traversable [GH_AddLabel](/opengraph/extensions/github/edges/gh_addlabel) edge represents a role's ability to add labels to issues and pull requests. This permission is available to Triage, Write, Maintain, and Admin roles and custom roles that have been granted this specific permission.
