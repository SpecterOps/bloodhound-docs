...
- Source: [GH_SamlIdentityProvider](/opengraph/extensions/github/nodes/gh_samlidentityprovider)
- Destination: [GH_ExternalIdentity](/opengraph/extensions/github/nodes/gh_externalidentity)
- Traversable: ❌
