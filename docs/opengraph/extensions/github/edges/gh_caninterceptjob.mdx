...
| Start | Kind | End |
|-------|-----------|-------|
| [GH_Runner](/opengraph/extensions/github/nodes/gh_runner) | GH_CanInterceptJob | [GH_WorkflowJob](/opengraph/extensions/github/nodes/gh_workflowjob) |
...
| --- | --- | --- |
| [GH_Runner](/opengraph/extensions/github/nodes/gh_runner) | [GH_WorkflowJob](/opengraph/extensions/github/nodes/gh_workflowjob) | `true` |
