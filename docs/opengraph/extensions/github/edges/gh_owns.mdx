...
| Start | Kind | End |
|-------|-----------|-------|
| [GH_Organization](/opengraph/extensions/github/nodes/gh_organization) | GH_Owns | [GH_Repository](/opengraph/extensions/github/nodes/gh_repository) |
...
| --- | --- | --- |
| [GH_Organization](/opengraph/extensions/github/nodes/gh_organization) | [GH_Repository](/opengraph/extensions/github/nodes/gh_repository) | `true` |
