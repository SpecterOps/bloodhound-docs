...
| Start | Kind | End |
|-------|-----------|-------|
| [GH_App](/opengraph/extensions/github/nodes/gh_app) | GH_InstalledAs | [GH_AppInstallation](/opengraph/extensions/github/nodes/gh_appinstallation) |
...
| --- | --- | --- |
| [GH_App](/opengraph/extensions/github/nodes/gh_app) | [GH_AppInstallation](/opengraph/extensions/github/nodes/gh_appinstallation) | `true` |
