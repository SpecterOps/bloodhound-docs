...
| Start | Kind | End |
|-------|-----------|-------|
| [GH_WorkflowJob](/opengraph/extensions/github/nodes/gh_workflowjob) | GH_CallsWorkflow | [GH_Workflow](/opengraph/extensions/github/nodes/gh_workflow) |
...
| --- | --- | --- |
| [GH_WorkflowJob](/opengraph/extensions/github/nodes/gh_workflowjob) | [GH_Workflow](/opengraph/extensions/github/nodes/gh_workflow) | `false` |
