...
| Start | Kind | End |
|-------|-----------|-------|
| [GH_WorkflowJob](/opengraph/extensions/github/nodes/gh_workflowjob) | GH_DependsOn | [GH_WorkflowJob](/opengraph/extensions/github/nodes/gh_workflowjob) |
...
| --- | --- | --- |
| [GH_WorkflowJob](/opengraph/extensions/github/nodes/gh_workflowjob) | [GH_WorkflowJob](/opengraph/extensions/github/nodes/gh_workflowjob) | `false` |
