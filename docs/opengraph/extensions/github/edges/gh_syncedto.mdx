...
- Source: [AZUser](/resources/nodes/az-user), [Okta_User](/opengraph/extensions/okta/nodes/okta_user), [PingOneUser](https://github.com/andyrobbins/PingOneHound?tab=readme-ov-file#schema)
- Destination: [GH_User](/opengraph/extensions/github/nodes/gh_user)
- Traversable: ✅
