...
- Source: [GH_RepoRole](/opengraph/extensions/github/nodes/gh_reporole), [GH_User](/opengraph/extensions/github/nodes/gh_user), [GH_Team](/opengraph/extensions/github/nodes/gh_team)
...
User or Team listed in the wildcard BPR's `pushAllowances` can create branches. This is a per-actor delta edge — only emitted when the actor's role doesn't already grant [GH_CanCreateBranch](/opengraph/extensions/github/edges/gh_cancreatebranch).
