...
- Source: [GH_Organization](/opengraph/extensions/githound/reference/nodes/gh_organization)
- Destination: [GH_SamlIdentityProvider](/opengraph/extensions/githound/reference/nodes/gh_samlidentityprovider)
- Traversable: ❌
