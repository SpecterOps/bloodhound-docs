...
The non-traversable [GH_SetMilestone](/opengraph/extensions/github/edges/gh_setmilestone) edge represents a role's ability to set milestones on issues and pull requests. This permission is available to Triage, Write, Maintain, and Admin roles and custom roles that have been granted this specific permission.
