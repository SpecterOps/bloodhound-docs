...
| Start | Kind | End |
|-------|-----------|-------|
| [GH_WorkflowJob](/opengraph/extensions/github/nodes/gh_workflowjob) | GH_RunsOn | [GH_Runner](/opengraph/extensions/github/nodes/gh_runner) |
...
| --- | --- | --- |
| [GH_WorkflowJob](/opengraph/extensions/github/nodes/gh_workflowjob) | [GH_Runner](/opengraph/extensions/github/nodes/gh_runner) | `false` |
