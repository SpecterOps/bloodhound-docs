...
| Start | Kind | End |
|-------|-----------|-------|
| [GH_OrgRole](/opengraph/extensions/github/nodes/gh_orgrole) | GH_ViewSecretScanningAlerts | [GH_Organization](/opengraph/extensions/github/nodes/gh_organization) |
| [GH_RepoRole](/opengraph/extensions/github/nodes/gh_reporole) | GH_ViewSecretScanningAlerts | [GH_Repository](/opengraph/extensions/github/nodes/gh_repository) |
