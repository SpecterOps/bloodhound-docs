...
| Start | Kind | End |
|-------|-----------|-------|
| [GH_User](/opengraph/extensions/github/nodes/gh_user) | GH_HasPersonalAccessTokenRequest | [GH_PersonalAccessTokenRequest](/opengraph/extensions/github/nodes/gh_personalaccesstokenrequest) |
...
| --- | --- | --- |
| [GH_User](/opengraph/extensions/github/nodes/gh_user) | [GH_PersonalAccessTokenRequest](/opengraph/extensions/github/nodes/gh_personalaccesstokenrequest) | `false` |
