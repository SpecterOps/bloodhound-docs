...
- Source: [GH_RepoRole](/opengraph/extensions/githound/reference/nodes/gh_reporole), [GH_User](/opengraph/extensions/githound/reference/nodes/gh_user), [GH_Team](/opengraph/extensions/githound/reference/nodes/gh_team)
- Destination: [GH_Branch](/opengraph/extensions/githound/reference/nodes/gh_branch)
- Traversable: ✅
