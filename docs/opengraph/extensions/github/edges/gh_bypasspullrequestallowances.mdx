...
| Start | Kind | End |
|-------|-----------|-------|
| [GH_User](/opengraph/extensions/github/nodes/gh_user) | GH_BypassPullRequestAllowances | [GH_BranchProtectionRule](/opengraph/extensions/github/nodes/gh_branchprotectionrule) |
...
| --- | --- | --- |
| [GH_User](/opengraph/extensions/github/nodes/gh_user) | [GH_BranchProtectionRule](/opengraph/extensions/github/nodes/gh_branchprotectionrule) | `false` |
