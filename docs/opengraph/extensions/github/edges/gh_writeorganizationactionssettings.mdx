...
- Source: [GH_OrgRole](/opengraph/extensions/githound/reference/nodes/gh_orgrole)
- Destination: [GH_Organization](/opengraph/extensions/githound/reference/nodes/gh_organization)
- Traversable: ❌
