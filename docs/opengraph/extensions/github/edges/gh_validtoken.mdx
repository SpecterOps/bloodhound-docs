...
| Start | Kind | End |
|-------|-----------|-------|
| [GH_SecretScanningAlert](/opengraph/extensions/github/nodes/gh_secretscanningalert) | GH_ValidToken | [GH_User](/opengraph/extensions/github/nodes/gh_user) |
...
| --- | --- | --- |
| [GH_SecretScanningAlert](/opengraph/extensions/github/nodes/gh_secretscanningalert) | [GH_User](/opengraph/extensions/github/nodes/gh_user) | `true` |
