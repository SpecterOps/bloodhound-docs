...
The non-traversable [GH_AddAssignee](/opengraph/extensions/github/edges/gh_addassignee) edge represents a role's ability to assign users to issues and pull requests. This permission is available to Triage, Write, Maintain, and Admin roles and custom roles that have been granted this specific permission.
