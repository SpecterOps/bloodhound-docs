...
| Start | Kind | End |
|-------|-----------|-------|
| [GH_RepoRole](/opengraph/extensions/github/nodes/gh_reporole) | GH_EditRepoCustomPropertiesValues | [GH_Repository](/opengraph/extensions/github/nodes/gh_repository) |
