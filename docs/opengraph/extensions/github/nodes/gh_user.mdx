...
| [GH_SyncedTo](/opengraph/extensions/githound/reference/edges/gh_syncedto) | [AZUser](/resources/nodes/az-user), [Okta_User](/opengraph/extensions/oktahound/reference/nodes/okta_user), [PingOneUser](https://github.com/andyrobbins/PingOneHound?tab=readme-ov-file#schema) | ✅ |
