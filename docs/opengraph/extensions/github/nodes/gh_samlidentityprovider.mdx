...
| --------- | ----------------- | ----------- |
| [GH_HasSamlIdentityProvider](/opengraph/extensions/github/edges/gh_hassamlidentityprovider) | [GH_Organization](/opengraph/extensions/github/nodes/gh_organization) | ❌ |
