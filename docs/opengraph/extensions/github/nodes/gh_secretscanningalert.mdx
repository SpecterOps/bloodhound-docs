...
| --------- | ----------------- | ----------- |
| [GH_CanReadSecretScanningAlert](/opengraph/extensions/github/edges/gh_canreadsecretscanningalert) | [GH_OrgRole](/opengraph/extensions/github/nodes/gh_orgrole), [GH_RepoRole](/opengraph/extensions/github/nodes/gh_reporole) | ✅ |
...
| --------- | ---------------------- | ----------- |
| [GH_ValidToken](/opengraph/extensions/github/edges/gh_validtoken) | [GH_User](/opengraph/extensions/github/nodes/gh_user) | ✅ |
