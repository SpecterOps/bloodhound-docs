...
This document describes the computed edge functions and what they produce. For the empirical testing that validates the underlying security model, see [Mitigating Controls](/opengraph/extensions/github/mitigating-controls).
