...
description: Create an Okta API service application for OktaHound
---
...
<Steps>
  <Step title="Open the Applications page">
    ...
    <Frame>
      <img src="/images/extensions/OktaHound/Screenshots/app-registration1.png" alt="Okta Admin Console - Applications page" />
    </Frame>
  </Step>
  ...
  <Step title="Select API Services">
    ...
    <Frame>
      <img src="/images/extensions/OktaHound/Screenshots/app-registration2.png" alt="Create a new app integration - select API Services" />
    </Frame>
  </Step>
  ...
  <Step title="Name the application">
    ...
    <Frame>
      <img src="/images/extensions/OktaHound/Screenshots/app-registration3.png" alt="New API Services App Integration - name" />
    </Frame>
  </Step>
  ...
  <Step title="Configure public key authentication">
    ...
    <Frame>
      <img src="/images/extensions/OktaHound/Screenshots/app-registration4.png" alt="OktaHound app - Client Credentials" />
    </Frame>

    Under **Client Credentials**, click **Edit** and change **Client authentication** from **Client secret** to **Public key / Private key**.

    <Frame>
      <img src="/images/extensions/OktaHound/Screenshots/app-registration5.png" alt="Switch to Public key / Private key authentication" />
    </Frame>
  </Step>
  ...
  <Step title="Generate a key pair">
    ...
    <Frame>
      <img src="/images/extensions/OktaHound/Screenshots/app-registration6.png" alt="Add a public key dialog" />
    </Frame>

    <Frame>
      <img src="/images/extensions/OktaHound/Screenshots/app-registration7.png" alt="Generated key pair - copy the private key" />
    </Frame>
  ...
  <Step title="Save the credentials">
    Verify the key appears in the PUBLIC KEYS table, then click **Save**. Confirm the prompt that existing client secrets will no longer be used.

    <Frame>
      <img src="/images/extensions/OktaHound/Screenshots/app-registration8.png" alt="Public key listed in credentials" />
    </Frame>

    <Frame>
      <img src="/images/extensions/OktaHound/Screenshots/app-registration9.png" alt="Confirm client secret removal" />
    </Frame>
  </Step>

  <Step title="Uncheck the Require Demonstrating of Proof of Possession">
    Uncheck the **Require Demonstrating of Proof of Possession (DPoP)** option and click the **Save**.

    <Frame>
      <img src="/images/extensions/OktaHound/Screenshots/app-registration10.png" alt="OktaHound General Settings" />
    </Frame>
  </Step>
  ...
  <Step title="Grant OAuth 2.0 scopes">
    ...
    The Okta application registration used by `OktaHound` requires the following [OAuth 2.0 scopes](https://developer.okta.com/docs/api/oauth2/) for the data collection to function correctly:
