...
This selector is defined in the [organization.json](https://github.com/SpecterOps/OktaHound/tree/main/Documentation/PrivilegeZoneSelectors/organization.json) file.
...
This selector is defined in the [tier0-devices.json](https://github.com/SpecterOps/OktaHound/tree/main/Documentation/PrivilegeZoneSelectors/tier0-devices.json) file.
...
This selector is defined in the [tier0-principals.json](https://github.com/SpecterOps/OktaHound/tree/main/Documentation/PrivilegeZoneSelectors/tier0-principals.json) file.
