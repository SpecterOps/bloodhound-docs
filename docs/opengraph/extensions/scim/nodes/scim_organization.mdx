...
| --------- | ---------------------- | ----------- |
| [SCIM_Contains](/opengraph/extensions/scim/edges/scim_contains) | [SCIM_User](/opengraph/extensions/scim/nodes/scim_user), [SCIM_Group](/opengraph/extensions/scim/nodes/scim_group), [SCIM_Role](/opengraph/extensions/scim/nodes/scim_role) | ✅ |
