...
The SCIM extension defines a small, focused model with four node types and five edge types. See the [schema reference](/opengraph/extensions/scim/reference/schema) for the full details.
...
- [OktaHound Extension](/opengraph/extensions/oktahound/overview)
- [GitHound Extension](/opengraph/extensions/githound/overview)
- [SCIM Schema Reference](/opengraph/extensions/scim/reference/schema)
