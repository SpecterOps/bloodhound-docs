...
1. Upload the SCIM schema to your BloodHound instance alongside the extension schemas for the collectors you are using (for example, Okta or GitHub).
   ...
   In BloodHound Enterprise v9.3.0 and later, verify whether the platform extension (such as GitHub, Jamf, or Okta) is already installed as a built-in extension before you upload the SCIM companion schema.
