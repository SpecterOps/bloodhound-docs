...
description: Define nodes in your OpenGraph data payloads.
sidebarTitle: Nodes
---
...
To include a node in analysis and metrics, set `properties.collected` to the boolean value `true`.

- `collected: true`: node is included in analysis and metrics.
- `collected: false` or missing `collected`: node is treated as reference data and excluded from analysis and metrics.
