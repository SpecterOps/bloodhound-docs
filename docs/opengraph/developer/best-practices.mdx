...
1. Privilege Zone Rules
    - Queries for creating [Cypher-based](/analyze-data/privilege-zones/rules#cypher) Privilege Zone rules to help users classify high-value nodes in the graph
...
1. Icon Definition Pack
    ...
    <Note>
      Only necessary for generic graph data. Structured graphs include icon definitions in the [extension definition schema](/opengraph/developer/graph-definition).
    </Note>
