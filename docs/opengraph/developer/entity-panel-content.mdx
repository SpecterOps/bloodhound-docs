...
| `markdown.content` | Markdown rendered in the section body. Required when `markdown` is present. You can use static Markdown or a Go template that renders values for the selected entity. See [Dynamic Entity Panel content](/opengraph/developer/entity-panel-content#dynamic-entity-panel-content). |
