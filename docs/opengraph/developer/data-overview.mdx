...
| Enable pathfinding and findings/analysis for extension relationships | Valid payload schema and an installed extension definition schema that the payload conforms to | Structured graph |
