...
You can optionally include a top-level `metadata` object in your payload.

For supported fields and behavior, see [OpenGraph Metadata](/opengraph/developer/metadata).
