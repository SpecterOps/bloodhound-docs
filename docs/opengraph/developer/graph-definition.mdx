...
<ResponseField name="is_display_kind" type="boolean">
  ...
  See [Schema Behavior Examples](/opengraph/developer/schema-behavior-examples#define-node-styling) for a comparison of how display kinds affect node appearance in BloodHound.
</ResponseField>
...
<ResponseField name="environment_kind" type="string" required>
  ...
  See [Schema Behavior Examples](/opengraph/developer/schema-behavior-examples#define-environments) for an example of how BloodHound uses environment definitions in the UI.
</ResponseField>
...
<ResponseField name="principal_kinds" type="array" required>
  ...
  See [Schema Behavior Examples](/opengraph/developer/schema-behavior-examples#define-principals) for an example of how principal definitions affect analysis scope.
</ResponseField>
...
<ResponseField name="remediation" type="object">
  ...
  See [Schema Behavior Examples](/opengraph/developer/schema-behavior-examples#define-relationship-findings) for an example of how finding and remediation text appears in BloodHound.
</ResponseField>
