...
<ResponseField name="is_display_kind" type="boolean">
  ...
  See the [extension example](/opengraph/developer/extension-example#define-node-styling) to see how display kinds affect node appearance in BloodHound.
</ResponseField>
...
<ResponseField name="environment_kind" type="string" required>
  ...
  See the [extension example](/opengraph/developer/extension-example#define-environments) to see how BloodHound uses environment definitions in the UI.
</ResponseField>
...
<ResponseField name="principal_kinds" type="array" required>
  ...
  See the [extension example](/opengraph/developer/extension-example#define-principals) to see how principal definitions affect analysis scope.
</ResponseField>
...
<ResponseField name="remediation" type="object">
  ...
  See the [extension example](/opengraph/developer/extension-example#define-relationship-findings) to see how finding and remediation text appears in BloodHound.
</ResponseField>
