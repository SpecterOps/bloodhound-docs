...
<Note>
  In BloodHound Enterprise v9.3.0 and later, supported platform extensions (GitHub, Jamf, and Okta) are built-in and pre-installed. Other SpecterOps-supported schemas, such as SCIM, must still be uploaded manually.
</Note>
