...
<ResponseField name="info" type="object">
  Optional [custom Entity Panel content](/opengraph/developer/entity-panel-content#custom-entity-panel-content) for nodes of this kind.
</ResponseField>
...
<ResponseField name="info" type="object">
  Optional [custom Entity Panel content](/opengraph/developer/entity-panel-content#custom-entity-panel-content) for relationships of this kind.
</ResponseField>
