...
description: Description of the OpenGraph edge schema and requirements for ingestion into BloodHound.
---
...
For payload-level structure, see [OpenGraph Data](/opengraph/developer/data-overview).
...
- **Expected edge disappears after ingest:** Check whether it is a post-processed edge kind that BloodHound regenerates.
