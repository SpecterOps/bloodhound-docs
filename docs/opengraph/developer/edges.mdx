...
- [`AddEntraDSGroupMember`](/resources/edges/add-entra-ds-group-member)
- [`AddMember`](/resources/edges/add-member)
- [`AdminTo`](/resources/edges/admin-to)
- [`AZAddOwner`](/resources/edges/az-add-owner)
- [`AZManageEntraDS`](/resources/edges/az-manage-entra-ds)
...
- [`EntraDSFor`](/resources/edges/entra-ds-for)
...
- [`ManageEntraDSSync`](/resources/edges/manage-entra-ds-sync)
- [`ManageEntraDSSyncFilter`](/resources/edges/manage-entra-ds-sync-filter)
...
- [`SyncedToEntraDSGroup`](/resources/edges/synced-to-entra-ds-group)
- [`SyncedToEntraDSUser`](/resources/edges/synced-to-entra-ds-user)
