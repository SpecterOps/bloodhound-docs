...
To switch to a PostgreSQL graph database, set `"graph_driver": "pg"` in your BloodHound configuration file and restart the BloodHound services/containers. You will need to re-ingest any data into the new database.
</Accordion>
