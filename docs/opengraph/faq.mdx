...
Yes! BloodHound supports **Search** and **Pathfinding** for [_structured_](/opengraph/extensions/manage#structured-graphs) graphs.

For [_generic_](/opengraph/extensions/manage#generic-graphs) graphs, only **Search** and **Cypher** are supported. Custom node type prefixes in queries are not yet supported.
</Accordion>
