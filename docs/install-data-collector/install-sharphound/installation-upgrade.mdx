...
<Steps>
  ...
  After installation, register and start the SharpHound Delegator service. Replace the placeholder values to match your environment.

  ```powershell
  $ServiceName = "SharpHoundDelegator"
  $DisplayName = "SharpHound Delegator"
