...
<Steps>
  ...
  <Frame>
    <img src="/assets/image-39.png" alt="Download Collectors option in BloodHound Enterprise"/>
  </Frame>
  </Step>
  ...
  If Microsoft Defender SmartScreen displays a warning:

  Click **More info**.

  <Frame>
    <img src="/assets/image-41.png" alt="Microsoft Defender SmartScreen warning"/>
  </Frame>

  Confirm that the publisher is **Specter Ops, Inc.**, then click **Run anyway**.

  <Frame>
    <img src="/assets/image-42.png" alt="SmartScreen prompt showing publisher details"/>
  </Frame>
  </Step>
  ...
  <Frame>
    <img src="/assets/image-43.png" alt="SharpHound Enterprise installer path selection"/>
  </Frame>
  </Step>
  ...
  <Frame>
    <img src="/assets/image-44.png" alt="SharpHound Enterprise installer ready to install"/>
  </Frame>
  </Step>
  ...
  <Frame>
    <img src="/assets/image-45.png" alt="SharpHound Enterprise installer service account credentials screen"/>
  </Frame>
  </Step>
  ...
  <Frame>
    <img src="/assets/image-46.png" alt="SharpHound Enterprise installer completion screen"/>
  </Frame>
  </Step>
...
<Steps>
  ...
  <Frame>
    <img src="/assets/image-49.png" alt="Download Collectors option for upgrading SharpHound Enterprise"/>
  </Frame>
  </Step>
  ...
  <Frame>
    <img src="/assets/image-51.png" alt="SharpHound Enterprise installer finish screen after upgrade"/>
  </Frame>
  </Step>
