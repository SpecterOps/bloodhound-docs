...
<Tip>You will need the managed identity **Client ID** to complete [AzureHound configuration](/install-data-collector/install-azurehound/create-configuration) later.</Tip>
...
<Steps>
  ...
  <Step title="Configure the app registration to use the managed identity">
