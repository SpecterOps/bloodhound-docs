...
<Info>You can complete the steps on this page manually using the sections below, or use the [PowerShell script at the bottom of this page](#scripted-configuration) to automate the entire process (except certificate upload).</Info>
