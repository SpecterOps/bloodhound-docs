...
<Steps>
  <Step title="Navigate to Entra ID Roles & admins">

    In the left menu, click **Entra ID** > **Roles & admins**.

  </Step>
  <Step title="Assign Directory Readers role">

    1. Search for the **Directory Readers** role and click the role name or description.

        <Note>Clicking the checkbox sometimes prevents clicking on the role itself.</Note>
...
<Note>If you skip this section, you will see a warning in the logs for each collection indicating the lack of ability to collect this data accordingly.</Note>
...
<Steps>
  ...
  <Step title="Add the Reader role assignment">
  ...
  <Step title="Review role assignment">
