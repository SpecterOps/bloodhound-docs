...
The application and service principal need permissions to collect data from your tenant as detailed in [AzureHound Data Collection and Permissions](/collect-data/azurehound-data-permissions).
